...
// getSession() resolves. First render already knows auth state = zero flash.
let HE_PREFETCHED_SESSION=null;
...
/* ── CONSTANTS ── */
const CATS=[
  {id:"vibe",    label:"Vibe",       emoji:"✨", sub:"Overall energy & presence"},
  {id:"humor",   label:"Humor",      emoji:"😂", sub:"How funny & lighthearted they are"},
  {id:"kindness",label:"Kindness",   emoji:"💛", sub:"Warmth, empathy & generosity"},
  {id:"rizz",    label:"Confidence", emoji:"😎", sub:"Self-assurance & magnetism"},
  {id:"loyalty", label:"Loyalty",    emoji:"🤝", sub:"Dependability & trustworthiness"},
  {id:"drip",    label:"Style",      emoji:"👗", sub:"Fashion sense & presentation"},
];
const BIZ_TYPES=[
  ...
  {id:"music",       label:"Music / DJ / Artist", emoji:"🎵"},
  {id:"coach",       label:"Coach / Educator",    emoji:"🎓"},
  {id:"service",     label:"Service Provider",    emoji:"💆"},
  {id:"fitness",     label:"Fitness / Wellness",  emoji:"🏋️"},
  {id:"tech",        label:"Tech / Agency",       emoji:"💻"},
  {id:"healthcare",  label:"Healthcare / Clinic", emoji:"🏥"},
];
const BIZ_CAT_MAP={
  general:[
    {id:"vibe",    label:"Customer Service", emoji:"🎧", sub:"How helpful, responsive & friendly the staff are"},
    {id:"humor",   label:"Trustworthy",      emoji:"🤝", sub:"Honesty, reliability & integrity of the business"},
    {id:"kindness",label:"Atmosphere",       emoji:"✨", sub:"Ambience, décor, vibe & physical environment"},
    {id:"rizz",    label:"Experience",       emoji:"❤️", sub:"Your overall end-to-end customer experience"},
    {id:"loyalty", label:"Quality",          emoji:"⭐", sub:"Standard of product, service or output delivered"},
    {id:"drip",    label:"Value for Money",  emoji:"💰", sub:"Whether the price is fair for what you received"},
  ],
  restaurant:[
    {id:"vibe",    label:"Food Quality",    emoji:"🍴", sub:"How good, fresh and well-made the food is"},
    {id:"humor",   label:"Service",         emoji:"🎧", sub:"How attentive, friendly and prompt the staff are"},
    {id:"kindness",label:"Ambience",        emoji:"✨", sub:"The overall feel, décor and vibe of the place"},
    {id:"rizz",    label:"Value for Money", emoji:"💰", sub:"Whether the price is fair for what you got"},
    {id:"loyalty", label:"Cleanliness",     emoji:"🧼", sub:"Hygiene standards of the food and space"},
    {id:"drip",    label:"Wait Time",       emoji:"⏱️", sub:"How reasonable the wait is for food or seating"},
  ],
  retail:[
    {id:"vibe",    label:"Product Quality",    emoji:"📦", sub:"How good and reliable the products are"},
    {id:"humor",   label:"Staff Helpfulness",  emoji:"🎧", sub:"How knowledgeable and helpful the staff are"},
    {id:"kindness",label:"Store Experience",   emoji:"✨", sub:"The overall feel and ease of shopping here"},
    {id:"rizz",    label:"Value for Money",    emoji:"💰", sub:"Whether the prices feel fair for the quality"},
    {id:"loyalty", label:"Trustworthy",        emoji:"🤝", sub:"How reliable, honest and safe to buy from"},
    {id:"drip",    label:"Return Policy",      emoji:"🔄", sub:"How fair and easy their return or refund process is"},
  ],
  creator:[
    {id:"vibe",    label:"Content Quality",     emoji:"🎬", sub:"How well-made, edited and polished the content is"},
    {id:"humor",   label:"Creativity",          emoji:"💡", sub:"How original and fresh their ideas are"},
    {id:"kindness",label:"Entertainment Value", emoji:"🎭", sub:"How enjoyable, fun and binge-worthy the content is"},
    {id:"rizz",    label:"Informativeness",     emoji:"📚", sub:"How much value, knowledge or insight they deliver"},
    {id:"loyalty", label:"Production Value",    emoji:"🎥", sub:"Visuals, sound design and overall presentation quality"},
    {id:"drip",    label:"Engagement",          emoji:"💬", sub:"How well they connect with and respond to their audience"},
  ],
  music:[
    {id:"vibe",    label:"Sound Quality",     emoji:"🎧", sub:"How good their music, mixes or production actually sounds"},
    {id:"humor",   label:"Stage Presence",    emoji:"🎤", sub:"Energy and vibe they bring to a live set or performance"},
    {id:"kindness",label:"Originality",       emoji:"🌟", sub:"How fresh and unique their sound or style is"},
    {id:"rizz",    label:"Versatility",       emoji:"🎛️", sub:"Range across genres, moods or crowd types"},
    {id:"loyalty", label:"Crowd Connection",  emoji:"🙌", sub:"How well they read and engage the room or audience"},
    {id:"drip",    label:"Overall Vibe",      emoji:"✨", sub:"The feeling their music leaves you with"},
  ],
  coach:[
    {id:"vibe",    label:"Knowledge",         emoji:"🧠", sub:"Depth of expertise and subject matter command"},
    {id:"humor",   label:"Communication",     emoji:"🗣️", sub:"How clearly and engagingly they explain things"},
    {id:"kindness",label:"Results",           emoji:"📈", sub:"Whether their coaching actually leads to improvement"},
    {id:"rizz",    label:"Reliability",       emoji:"🤝", sub:"How consistent, punctual and dependable they are"},
    {id:"loyalty", label:"Value for Money",   emoji:"💰", sub:"Whether the cost is justified by the outcome"},
    {id:"drip",    label:"Approachability",   emoji:"😊", sub:"How comfortable and safe they make you feel to learn"},
  ],
  service:[
    {id:"vibe",    label:"Skill Level",      emoji:"⚙️", sub:"How skilled and capable they are at what they do"},
    {id:"humor",   label:"Punctuality",      emoji:"⏱️", sub:"Whether they show up on time and meet deadlines"},
    {id:"kindness",label:"Communication",    emoji:"🗣️", sub:"How clearly they keep you informed throughout"},
    {id:"rizz",    label:"Cleanliness",      emoji:"🧼", sub:"How neat and tidy their work and workspace is"},
    {id:"loyalty", label:"Value for Money",  emoji:"💰", sub:"Whether the price feels fair for the quality of work"},
    {id:"drip",    label:"Trustworthy",      emoji:"🤝", sub:"How honest, reliable and safe to hire they are"},
  ],
  fitness:[
    {id:"vibe",    label:"Trainer Quality",  emoji:"💪", sub:"How skilled, motivating and knowledgeable the trainer is"},
    {id:"humor",   label:"Facilities",       emoji:"🏋️", sub:"Quality and availability of equipment and space"},
    {id:"kindness",label:"Atmosphere",       emoji:"✨", sub:"The energy, community feel and overall vibe"},
    {id:"rizz",    label:"Value for Money",  emoji:"💰", sub:"Whether the membership or session cost feels fair"},
    {id:"loyalty", label:"Results",          emoji:"📈", sub:"Whether training here actually delivers outcomes"},
    {id:"drip",    label:"Approachability",  emoji:"😊", sub:"How welcoming and inclusive it feels for all levels"},
  ],
  tech:[
    {id:"vibe",    label:"Delivery Quality", emoji:"💻", sub:"How good and polished the final work output is"},
    {id:"humor",   label:"Communication",    emoji:"🗣️", sub:"How clearly and regularly they update you"},
    {id:"kindness",label:"Deadlines",        emoji:"⏱️", sub:"Whether they deliver on time as promised"},
    {id:"rizz",    label:"Trustworthy",      emoji:"🤝", sub:"How honest and transparent they are throughout"},
    {id:"loyalty", label:"Value for Money",  emoji:"💰", sub:"Whether the cost matches the quality of work"},
    {id:"drip",    label:"Support",          emoji:"🎧", sub:"How responsive and helpful they are after delivery"},
  ],
  healthcare:[
    {id:"vibe",    label:"Doctor / Staff",   emoji:"👨‍⚕️", sub:"How skilled, thorough and professional the care is"},
    {id:"humor",   label:"Wait Time",        emoji:"⏱️", sub:"How long you waited before being seen"},
    {id:"kindness",label:"Cleanliness",      emoji:"🧼", sub:"Hygiene and cleanliness of the facility"},
    {id:"rizz",    label:"Communication",    emoji:"🗣️", sub:"How clearly they explain your condition and treatment"},
    {id:"loyalty", label:"Care & Empathy",   emoji:"💛", sub:"How kind, patient and understanding the staff are"},
    {id:"drip",    label:"Value for Money",  emoji:"💰", sub:"Whether the cost feels fair for the care received"},
  ],
};
const BIZ_TIERS=[
  {label:"New",       emoji:"🌱",min:0,   max:0,    color:"#4c5266",grad:["#3e4257","#4c5266"],glow:"#4c526618"},
  {label:"Starter",   emoji:"⚙️",min:1,   max:79,   color:"#7a8098",grad:["#636780","#7a8098"],glow:"#7a809820"},
  {label:"Reliable",  emoji:"🔵",min:80,  max:249,  color:"#3878b0",grad:["#2860a0","#4a90c8"],glow:"#3878b028"},
  {label:"Trusted",   emoji:"🟢",min:250, max:599,  color:"#10a37f",grad:["#0a8060","#20c09a"],glow:"#10a37f28"},
  {label:"Acclaimed", emoji:"🌟",min:600, max:1299, color:"#c08a2e",grad:["#a87020","#d8ac50"],glow:"#c08a2e28"},
...
const PALETTE=["#7b72e9","#10a37f","#e0466e","#4f80e2","#c08a2e","#2cba9a","#9b6ee8","#d95c4a"];
const INTERESTS=["Gaming 🎮","Music 🎵","Sports ⚽","Art 🎨","Food 🍜","Travel ✈️","Fitness 💪","Tech 💻","Fashion 👗","Books 📚","Movies 🎬","Anime 🌸","Photography 📷","Cooking 🍳","Dance 💃","Comedy 😄","Finance 💸","Crypto ₿","Entrepreneurship 🚀","Cars 🚗","Bikes 🏍️","Football 🏈","Cricket 🏏","Basketball 🏀","Badminton 🏸","Swimming 🏊","Hiking 🥾","Yoga 🧘","Poetry 📝","Drawing ✏️","Painting 🖌️","Singing 🎤","Acting 🎭","Makeup 💄","Skincare 🧴","Astrology ♈","Pets 🐾","Gardening 🌱","DIY 🔧","Interior Design 🏠","Philosophy 🤔","Psychology 🧠","History 📜","Science 🔬","Environment 🌍","Volunteering 🤲","Politics 🗳️","Memes 😭","Netflix 🍿","K-Pop 🎶","Hip-Hop 🎧","EDM 🎛️","Streetwear 👟","Sneakers 👟","Tattoos 🖊️","Poker ♠️","Chess ♟️","Board Games 🎲","Esports 🏆","VR Gaming 🥽","Podcasts 🎙️"];
const REPORT_REASONS=[
  {id:"spam",     label:"Spam",          desc:"Fake ratings or repeated content"},
  {id:"harass",   label:"Harassment",    desc:"Threatening or abusive behaviour"},
  {id:"fake",     label:"Fake Profile",  desc:"Impersonating someone else"},
  {id:"inapp",    label:"Inappropriate", desc:"Offensive content or photos"},
  {id:"underage", label:"Underage",      desc:"Appears to be under 13"},
...
/* ── SCORE FORMULA ──────────────────────────────────────────────────────────
   ...
   Max per rater = 100 pts.  Score is unlimited — grows with every new rater.
   Editing a rating: old per-rater avg is replaced, new one added in its place.
   Formula is identical for personal and business (6 categories each).
─────────────────────────────────────────────────────────────────────────────*/
const pScore=p=>{
  const r=p.ratings||[];
  if(!r.length)return null;
  const cats=getCats(p);
  // For each rater: mean of their 6 category values → sum across all raters.
  const total=r.reduce((sum,rating)=>{
    const raterAvg=cats.reduce((s,c)=>s+(rating[c.id]||0),0)/cats.length;
    return sum+raterAvg;
  },0);
...
const TIERS=[
  ...
  {label:"Ember",      emoji:"🔥",min:300,  max:899,   color:"#a07840",grad:["#8a6230","#c49050"],glow:"#a0784028"},
  {label:"Blaze",      emoji:"💥",min:900,  max:1799,  color:"#b84e48",grad:["#9a3840","#cc6860"],glow:"#b84e4828"},
  {label:"Nova",       emoji:"🌌",min:1800, max:2999,  color:"#7c56c0",grad:["#6340a8","#9470d8"],glow:"#7c56c030"},
  {label:"Stellar",    emoji:"🌠",min:3000, max:4799,  color:"#3878b0",grad:["#2860a0","#4a90c8"],glow:"#3878b030"},
  {label:"Eclipse",    emoji:"🌑",min:4800, max:7199,  color:"#5a3a8a",grad:["#3d2068","#7a52b0"],glow:"#5a3a8a30"},
  {label:"Aura",       emoji:"✴️",min:7200, max:10799, color:"#20a080",grad:["#108060","#30c0a0"],glow:"#20a08030"},
  {label:"Myth",       emoji:"🐉",min:10800,max:15599, color:"#c04080",grad:["#a02060","#e060a0"],glow:"#c0408040"},
...
function HomeIcon({active}){return IC(<><path d="M3 9l9-7 9 7v11a2 2 0 01-2 2H5a2 2 0 01-2-2z" fill={active?"currentColor":"none"}/><polyline points="9 22 9 12 15 12 15 22"/></>,active?2.2:1.6);}
function SearchIcon({active}){return IC(<><circle cx="11" cy="11" r="7"/><line x1="16.5" y1="16.5" x2="21" y2="21"/></>,active?2.2:1.6);}
function BoardIcon({active}){return IC(<><rect x="2" y="14" width="5" height="7" rx="1" fill={active?"currentColor":"none"}/><rect x="9.5" y="9" width="5" height="12" rx="1" fill={active?"currentColor":"none"}/><rect x="17" y="4" width="5" height="17" rx="1" fill={active?"currentColor":"none"}/></>,active?2.2:1.6);}
function MsgIcon2({active}){return IC(<><path d="M21 15a2 2 0 01-2 2H7l-4 4V5a2 2 0 012-2h14a2 2 0 012 2z" fill={active?"currentColor":"none"}/></>,active?2.2:1.6);}
function UserIcon({active}){return IC(<><path d="M20 21v-2a4 4 0 00-4-4H8a4 4 0 00-4 4v2" fill={active?"currentColor":"none"}/><circle cx="12" cy="7" r="4" fill={active?"currentColor":"none"}/></>,active?2.2:1.6);}
function SendIcon(){return IC(<><line x1="22" y1="2" x2="11" y2="13"/><polygon points="22 2 15 22 11 13 2 9 22 2"/></>);}
function BackIcon(){return IC(<><polyline points="15 18 9 12 15 6"/></>);}
function QrIcon(){return IC(<><rect x="3" y="3" width="7" height="7" rx="1"/><rect x="14" y="3" width="7" height="7" rx="1"/><rect x="3" y="14" width="7" height="7" rx="1"/><rect x="14" y="14" width="3" height="3"/><rect x="19" y="14" width="2" height="2"/><rect x="14" y="19" width="2" height="2"/><rect x="18" y="18" width="3" height="3" rx=".5"/></>);}
function EditIcon(){return IC(<><path d="M11 4H4a2 2 0 00-2 2v14a2 2 0 002 2h14a2 2 0 002-2v-7"/><path d="M18.5 2.5a2.121 2.121 0 013 3L12 15l-4 1 1-4 9.5-9.5z"/></>,1.8);}
function CamIcon(){return IC(<><path d="M23 19a2 2 0 01-2 2H3a2 2 0 01-2-2V8a2 2 0 012-2h4l2-3h6l2 3h4a2 2 0 012 2z"/><circle cx="12" cy="13" r="4"/></>);}
function ShieldIcon(){return IC(<><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></>,1.7);}
function FlagIcon(){return IC(<><path d="M4 15s1-1 4-1 5 2 8 2 4-1 4-1V3s-1 1-4 1-5-2-8-2-4 1-4 1z"/><line x1="4" y1="22" x2="4" y2="15"/></>,1.7);}
function DotsIcon(){return<svg width="20" height="20" viewBox="0 0 24 24" fill="none"><circle cx="5" cy="12" r="2" fill="currentColor"/><circle cx="12" cy="12" r="2" fill="currentColor"/><circle cx="19" cy="12" r="2" fill="currentColor"/></svg>;}
function XIcon(){return IC(<><line x1="18" y1="6" x2="6" y2="18"/><line x1="6" y1="6" x2="18" y2="18"/></>,2.2);}
function BellIcon(){return IC(<><path d="M18 8A6 6 0 006 8c0 7-3 9-3 9h18s-3-2-3-9"/><path d="M13.73 21a2 2 0 01-3.46 0"/></>,1.7);}

/* ── ATOMS ── */
function Spinner(){return<div style={{width:18,height:18,border:"2px solid #2a2a40",borderTopColor:AC,borderRadius:"50%",animation:"spin .55s linear infinite",display:"inline-block"}}/>;}

function TierBadge({sc,size="md",isBiz=false,showLevel=true}){
  const t=tierOf(sc??0,isBiz),isFama=t.label==="HighEnough";
  const {level}=tierLevel(sc??0,isBiz);
  const levelSuffix=(showLevel&&sc&&sc>0&&t.label!=="Ghost"&&t.label!=="New")?` L${level}`:"";
  const sz={sm:{px:"4px 10px",fs:11,ef:12,r:8},md:{px:"6px 14px",fs:13,ef:14,r:10}}[size]||{px:"4px 10px",fs:11,ef:12,r:8};
  const bg=isFama?`linear-gradient(135deg,${t.grad[0]}40,${t.grad[1]}28)`:`linear-gradient(135deg,${t.color}28,${t.color}14)`;
  const shimmer=isFama?{background:`linear-gradient(90deg,${t.grad[0]},${t.grad[1]},${t.grad[0]})`,backgroundSize:"200% auto",animation:"sh 2.6s linear infinite",WebkitBackgroundClip:"text",WebkitTextFillColor:"transparent",backgroundClip:"text"}:{color:t.color};
  return<span style={{display:"inline-flex",alignItems:"center",gap:5,background:bg,border:`1.5px solid ${t.color}${isFama?"60":"35"}`,borderRadius:sz.r,padding:sz.px,whiteSpace:"nowrap",boxShadow:isFama?`0 0 14px ${t.glow},0 2px 8px ${t.color}30`:`0 1px 4px ${t.color}20`}}>
    <span style={{fontSize:sz.ef,lineHeight:1,animation:isFama?"fl 3s ease infinite":"none"}}>{t.emoji}</span>
    <span style={{fontSize:sz.fs,fontFamily:"'JetBrains Mono',monospace",fontWeight:800,letterSpacing:"-.2px",...shimmer}}>{t.label}{levelSuffix}</span>
  </span>;
}
...
function Ava({p,size=46,T,badge,onClick,ring}){
  ...
  const borderStyle=ring?`3px solid ${c}`:`1.5px solid ${c}40`;
  return<div onClick={onClick} style={{width:size,height:size,borderRadius:"50%",flexShrink:0,background:`${c}18`,border:borderStyle,display:"flex",alignItems:"center",justifyContent:"center",fontWeight:700,fontSize:size*.3,color:c,fontFamily:"'JetBrains Mono',monospace",overflow:"hidden",cursor:onClick?"pointer":"default",position:"relative",boxShadow:isFama?`0 0 0 2px ${t.color}40,0 0 16px ${t.glow}`:"none"}}>
    {p?.photo?<img src={p.photo} alt="" style={{width:"100%",height:"100%",objectFit:"cover"}}/>:ini(p?.name)}
    {badge>0&&<div style={{position:"absolute",top:-2,right:-2,minWidth:15,height:15,borderRadius:99,background:"#d84040",border:`1.5px solid ${T?.nav||"#09090f"}`,display:"flex",alignItems:"center",justifyContent:"center",fontSize:8,color:"#fff",fontWeight:700,padding:"0 3px"}}>{badge>9?"9+":badge}</div>}
  </div>;
}
...
function PrivacyPolicy({T,onClose}){
  return<Overlay onBg={onClose} T={T} wide>
    ...
    <div style={{fontSize:11,color:T.mu,marginBottom:16}}>Last updated: July 2025</div>
    <div style={{maxHeight:"62vh",overflowY:"auto",display:"flex",flexDirection:"column",gap:14,fontSize:13,lineHeight:1.75,color:T.mu}}>
      {[
        {h:"1. Introduction",b:"HighEnough is a Reputation Intelligence Platform that lets individuals, professionals, and businesses build, share, and understand their real-world reputation. This Privacy Policy explains what information we collect, how we use it, and the choices you have. We believe in being transparent — if you have any questions, you can reach us at privacy@highenough.in."},
        {h:"2. Information We Collect",b:"We collect information you provide when creating an account: your name, email address, profile photo, bio, date of birth (optional, kept private), interests, and links. We also collect information generated through your activity on HighEnough: ratings you give and receive, followers and following relationships, messages you send, notifications, and your selected categories (Personal or Business/Professional). We do not collect phone numbers, financial information, or government identity documents."},
        {h:"3. How Information Is Used",b:"We use your information to operate the HighEnough platform — displaying your profile and reputation tier, calculating your reputation score, enabling messaging and follows, and delivering notifications. We use your email to authenticate you and to communicate important account updates. We do not use your data to serve third-party advertisements, and we do not sell your personal information."},
        {h:"4. Reputation Data",b:"Your reputation score is calculated from ratings submitted by other verified HighEnough users. We do not manually alter, inflate, or suppress scores. Scores are derived entirely from community input. A HighEnough reputation score is one perspective — it is not a certified character assessment, background check, or verified credential. We do not guarantee that reputation scores are accurate, complete, or free from bias."},
        {h:"5. User Content",b:"Ratings, profile details, and other content you publish on HighEnough are visible to other users of the platform. Direct messages are only visible to you and the person you are messaging. You are responsible for the content you post. If you believe content relating to you has been posted in violation of our policies, you can report it within the app."},
        {h:"6. Cookies & Similar Technologies",b:"We store your session token (managed by Supabase) and your display preferences (such as dark or light mode) in your browser's local storage. We do not use third-party tracking cookies, advertising pixels, or fingerprinting technologies. We do not track you across other websites or applications."},
        {h:"7. Third-Party Services",b:"We use Supabase (supabase.com) to manage authentication, database storage, and real-time features. Sign-in via Google is available and governed by Google's own Privacy Policy. When you sign in with Google, Google may share your name and email address with us. We do not have access to your Google password or any other Google account data beyond what you explicitly authorise."},
        {h:"8. Future Integrations",b:"HighEnough may in the future offer integrations with hiring platforms, HR systems, dating applications, freelancing marketplaces, and other services. Any such integration will require your explicit consent before your reputation data is shared with a third party. We will never share your data with a partner platform without your knowledge and authorisation."},
        {h:"9. Data Security",b:"All data is stored on Supabase infrastructure, which provides encryption at rest and in transit (TLS). We use Row Level Security (RLS) policies to ensure users can only access data they are authorised to see. No system is completely impenetrable. We take reasonable steps to protect your information, but we cannot guarantee absolute security."},
        {h:"10. Data Retention",b:"We retain your data for as long as your account is active. If you delete your account, your profile, ratings, messages, follows, and associated data are permanently and irreversibly removed from our active database. We do not retain your personal data after account deletion, except where required by law. Supabase may retain authentication logs for a short period for security and abuse prevention purposes."},
        {h:"11. User Rights",b:"You can access, update, or delete your personal information at any time through Settings. You may delete your account permanently from Settings → Account → Delete Account. If you have questions about your data or wish to request a record of what we hold, contact us at privacy@highenough.in. Depending on your location, you may have additional rights under applicable privacy laws, including the right to data portability and the right to object to processing."},
        {h:"12. Children's Privacy",b:"HighEnough is not intended for anyone under the age of 13. We do not knowingly collect personal information from children under 13. If we become aware that a child under 13 has created an account, we will delete it and all associated data promptly."},
        {h:"13. International Users",b:"HighEnough is operated from India. If you are accessing HighEnough from outside India, your data will be transferred to and processed on infrastructure located within the regions where our service providers (including Supabase) operate. By using HighEnough, you consent to this transfer and processing."},
        {h:"14. Policy Updates",b:"We may update this Privacy Policy from time to time. When we do, we will update the date at the top of this document and, for significant changes, notify you within the app. Your continued use of HighEnough after changes take effect constitutes acceptance of the updated policy."},
        {h:"15. Contact Information",b:"For privacy-related questions, data requests, or deletion inquiries, contact us at: privacy@highenough.in. We aim to respond to all privacy requests within 7 business days."},
      ].map(({h,b})=><div key={h}>
...
function TermsOfService({T,onClose}){
  return<Overlay onBg={onClose} T={T} wide>
    ...
    <div style={{maxHeight:"62vh",overflowY:"auto",display:"flex",flexDirection:"column",gap:14,fontSize:13,lineHeight:1.75,color:T.mu}}>
      {[
        {h:"1. Introduction",b:"HighEnough is a Reputation Intelligence Platform that helps individuals, professionals, and businesses build and share their real-world reputation. By creating an account or using HighEnough in any way, you agree to these Terms of Service. If you do not agree, please do not use HighEnough."},
        {h:"2. Eligibility",b:"You must be at least 13 years old to create an account on HighEnough. By registering, you confirm that you meet this age requirement and that you have the legal capacity to agree to these Terms. If you are using HighEnough on behalf of a business or organisation, you confirm that you have the authority to bind that entity to these Terms."},
        {h:"3. User Accounts",b:"You are responsible for maintaining the confidentiality of your account credentials. You must provide accurate and truthful information when creating your profile. Each individual may maintain one personal account. Impersonating another person or organisation is strictly prohibited. If you believe your account has been compromised, contact us immediately at support@highenough.in."},
        {h:"4. Community Standards",b:"HighEnough is built on mutual respect and honesty. All users are expected to engage constructively. Harassment, bullying, hate speech, discrimination, threats, impersonation, spam, and any content designed to harm or intimidate others are strictly prohibited. We reserve the right to remove any content that violates these standards and to suspend or terminate accounts accordingly."},
        {h:"5. Ratings & Reviews",b:"Ratings must reflect genuine, first-hand experience or honest opinion. You may not submit ratings for people or businesses you have not had a real interaction with. Coordinated rating manipulation, fake reviews, revenge ratings, paid ratings, or any attempt to artificially inflate or suppress a reputation score are prohibited. We may remove ratings that appear to violate these rules."},
        {h:"6. Business & Professional Accounts",b:"Business and Professional accounts must accurately represent the entity or individual they belong to. You may not create a Business or Professional account under a name or identity that does not belong to you. Business accounts are subject to the same Community Standards and rating rules as personal accounts."},
        {h:"7. Reputation Scores",b:"A HighEnough reputation score is derived from community-submitted ratings. It reflects the collective opinion of users who have interacted with you. HighEnough does not endorse, certify, or guarantee the accuracy of any score. A reputation score is one data point — it does not constitute a background check, character verification, professional credential, or guarantee of any kind. Users must exercise their own judgement when acting on reputation information."},
        {h:"8. Content Ownership",b:"You retain ownership of the content you create on HighEnough, including your profile, bio, and any other material you contribute. By posting content on HighEnough, you grant us a non-exclusive, royalty-free licence to display, distribute, and use that content within the HighEnough platform. We will not sell your content to third parties."},
        {h:"9. Prohibited Activities",b:"You agree not to: use HighEnough for any unlawful purpose; attempt to access another user's account without permission; scrape, crawl, or extract data from HighEnough without written authorisation; use automated tools to submit ratings or create accounts; interfere with the platform's operation or security; or attempt to reverse-engineer, decompile, or extract our source code."},
        {h:"10. Account Suspension & Termination",b:"We reserve the right to suspend or permanently terminate any account that violates these Terms, without prior notice. You may delete your own account at any time from Settings → Account → Delete Account. Account deletion is permanent and irreversible. Upon deletion, your profile, ratings, messages, follows, and associated data are removed from our active database."},
        {h:"11. Future Integrations",b:"HighEnough may in the future offer integrations with hiring platforms, HR systems, dating applications, freelancing marketplaces, and similar services. If and when such integrations become available, your participation will always be voluntary and require your explicit consent before any of your reputation data is shared with an external platform."},
        {h:"12. Intellectual Property",b:"The HighEnough name, logo, platform design, features, and all original content produced by us are owned by the HighEnough team and protected by applicable intellectual property laws. You may not reproduce, copy, or distribute any part of HighEnough without our written permission."},
        {h:"13. Disclaimer",b:"HighEnough is provided on an 'as is' and 'as available' basis. We make no warranties, express or implied, regarding the reliability, accuracy, completeness, or fitness for a particular purpose of the platform or any reputation information displayed on it. We do not guarantee uptime or uninterrupted access."},
        {h:"14. Limitation of Liability",b:"To the maximum extent permitted by applicable law, HighEnough and its team members shall not be liable for any indirect, incidental, special, consequential, or punitive damages arising from your use of the platform, including any reliance on reputation scores or content displayed on HighEnough."},
        {h:"15. Changes to the Service",b:"We may update, modify, or discontinue features of HighEnough at any time. We will make reasonable efforts to notify users of significant changes. Your continued use of HighEnough after changes take effect constitutes acceptance of the updated Terms."},
        {h:"16. Governing Law",b:"These Terms are governed by the laws of India. Any disputes arising under or in connection with these Terms shall be subject to the exclusive jurisdiction of the courts located in India, unless otherwise required by applicable law in your jurisdiction."},
        {h:"17. Contact Information",b:"For questions, concerns, or reports related to these Terms of Service, contact us at: support@highenough.in. We aim to respond to all enquiries within 5 business days."},
      ].map(({h,b})=><div key={h}>
        <div style={{fontWeight:700,color:T.txt,marginBottom:4,fontSize:13}}>{h}</div>
        <div>{b}</div>
      </div>)}
...
function EditProfileModal({me,prefs,T,onClose,onSave,onEditPhoto,onQR}){
  ...
  const [ints,setInts]=useState(me.interests||[]);
  const [links,setLinks]=useState(me.links||{instagram:"",twitter:"",tiktok:"",website:""});
  const [bizTypeEdit,setBizTypeEdit]=useState(me.biz_type||"general");
  const [ok,setOk]=useState(false);
  const [hdStatus,setHdStatus]=useState(null);
  const hdTimer=useRef(null);
  const isBizProfile=me.account_type==="business";

  const inp={width:"100%",padding:"11px 13px",background:T.inp,border:`1px solid ${T.b1}`,borderRadius:11,color:T.txt,fontSize:13,outline:"none",boxSizing:"border-box",marginBottom:11};

  async function checkHandle(val){
    const clean=val.trim().replace(/^@/,"").toLowerCase();
    if(!clean||clean===(me.handle||"").replace(/^@/,"")){setHdStatus(null);return;}
    setHdStatus("checking");
    const {data}=await sb.from("profiles").select("id").eq("handle","@"+clean).neq("id",me.id).maybeSingle();
    setHdStatus(data?"taken":"ok");
  }
  function onHdChange(val){setHd(val);clearTimeout(hdTimer.current);hdTimer.current=setTimeout(()=>checkHandle(val),600);}

  function computeAge(dobStr){
    if(!dobStr)return null;
    try{const b=new Date(dobStr);const now=new Date();let a=now.getFullYear()-b.getFullYear();const m=now.getMonth()-b.getMonth();if(m<0||(m===0&&now.getDate()<b.getDate()))a--;return a>=0?a:null;}catch{return null;}
  }

  async function sv(){
    const bizTypeChanged=isBizProfile&&bizTypeEdit!==me.biz_type;
    if(bizTypeChanged){
      const confirmed=window.confirm("Changing your business category will clear all existing reviews and ratings so you can start fresh. Continue?");
      if(!confirmed)return;
    }
    onSave({name:nm.trim()||me.name,handle:hd.trim()||me.handle,bio:bio.trim(),color:col,age:computeAge(dob),dob:dob||null,interests:ints,links,biz_type:isBizProfile?bizTypeEdit:null,_clearRatings:bizTypeChanged});
    setOk(true);setTimeout(()=>setOk(false),2000);
  }

  function togInt(i){setInts(prev=>prev.includes(i)?prev.filter(x=>x!==i):[...prev,i].slice(0,6));}
  const hdClean=hd.trim().replace(/^@/,"");
  const hdBorderColor=hdStatus==="taken"?"#e0466e":hdStatus==="ok"?"#2cba9a":T.b1;

  return<Overlay onBg={onClose} T={T} wide>
    <div style={{fontWeight:700,fontSize:18,color:T.txt,marginBottom:18}}>Edit Profile</div>

    {/* Avatar */}
    <div style={{display:"flex",justifyContent:"center",marginBottom:12}}>
      <div style={{position:"relative"}}>
        <Ava p={{...me,color:col}} size={76} T={T}/>
        <button onClick={onEditPhoto} style={{position:"absolute",bottom:-3,right:-3,width:24,height:24,borderRadius:"50%",background:`${col}cc`,border:`2px solid ${T.card}`,display:"flex",alignItems:"center",justifyContent:"center"}}><EditIcon/></button>
      </div>
    </div>
    <div style={{display:"flex",gap:7,justifyContent:"center",marginBottom:18}}>{PALETTE.map(c=><div key={c} onClick={()=>setCol(c)} style={{width:22,height:22,borderRadius:"50%",background:c,cursor:"pointer",outline:col===c?`2.5px solid ${T.txt}`:"2.5px solid transparent",outlineOffset:2,transform:col===c?"scale(1.25)":"scale(1)",transition:"transform .12s"}}/>)}</div>

    <input value={nm} onChange={e=>setNm(e.target.value)} placeholder="Display Name" style={inp}/>
    <div style={{position:"relative",marginBottom:11}}>
      <input value={hd} onChange={e=>onHdChange(e.target.value)} placeholder="@username" style={{...inp,marginBottom:0,border:`1px solid ${hdBorderColor}`,paddingRight:32}}/>
      {hdStatus&&<span style={{position:"absolute",right:12,top:"50%",transform:"translateY(-50%)",fontSize:14,fontWeight:700,color:hdStatus==="taken"?"#e0466e":hdStatus==="ok"?"#2cba9a":T.mu}}>{hdStatus==="taken"?"✕":hdStatus==="ok"?"✓":"…"}</span>}
    </div>
    {hdStatus==="taken"&&<div style={{fontSize:11,color:"#e0466e",marginBottom:8}}>@{hdClean} is already taken</div>}
    {hdStatus==="ok"&&<div style={{fontSize:11,color:"#2cba9a",marginBottom:8}}>@{hdClean} is available ✓</div>}
    <input value={bio} onChange={e=>setBio(e.target.value)} placeholder={isBizProfile?"What do you offer?":"Bio"} style={inp}/>

    {/* Business category selector */}
    {isBizProfile&&<div style={{marginBottom:11}}>
      <div style={{fontSize:11,color:T.mu,textTransform:"uppercase",letterSpacing:.8,fontWeight:600,marginBottom:8}}>Business / Professional Category</div>
      <div style={{display:"flex",flexDirection:"column",gap:6,maxHeight:320,overflowY:"auto",padding:2}}>
        {BIZ_TYPES.map(bt=>{const cats=BIZ_CAT_MAP[bt.id]||[];return<div key={bt.id} onClick={()=>setBizTypeEdit(bt.id)} style={{padding:"11px 13px",background:bizTypeEdit===bt.id?`${AC}14`:T.faint,border:`1.5px solid ${bizTypeEdit===bt.id?AC+"60":T.b1}`,borderRadius:11,cursor:"pointer",display:"flex",alignItems:"flex-start",gap:10,transition:"all .15s"}}>
          <span style={{fontSize:20,flexShrink:0,marginTop:1}}>{bt.emoji}</span>
          <div style={{flex:1,minWidth:0}}>
            <div style={{fontWeight:600,fontSize:13,color:T.txt,marginBottom:4}}>{bt.label}</div>
            <div style={{display:"flex",flexWrap:"wrap",gap:4}}>
              {cats.map(c=><span key={c.id} style={{fontSize:10,color:bizTypeEdit===bt.id?AC:T.mu,background:bizTypeEdit===bt.id?`${AC}10`:T.b1,borderRadius:4,padding:"1px 7px",border:`1px solid ${bizTypeEdit===bt.id?AC+"30":"transparent"}`}}>{c.emoji} {c.label}</span>)}
            </div>
          </div>
          {bizTypeEdit===bt.id&&<div style={{width:16,height:16,borderRadius:"50%",background:AC,flexShrink:0,display:"flex",alignItems:"center",justifyContent:"center",marginTop:2}}><svg width="8" height="8" viewBox="0 0 10 10" fill="none"><polyline points="1.5,5 4,7.5 8.5,2.5" stroke="#fff" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/></svg></div>}
        </div>;})}
      </div>
    </div>}

    {/* DOB for personal only */}
    {!isBizProfile&&<>
      <div style={{fontSize:11,color:T.mu,textTransform:"uppercase",letterSpacing:.8,fontWeight:600,marginBottom:6}}>Date of Birth <span style={{fontSize:10,opacity:.6,fontWeight:400,textTransform:"none"}}>(private)</span></div>
      <input type="date" value={dob} onChange={e=>setDob(e.target.value)} max={new Date().toISOString().split("T")[0]} style={{...inp,marginBottom:4,colorScheme:T===DK?"dark":"light"}}/>
      {dob&&computeAge(dob)!==null&&<div style={{fontSize:11,color:AC,marginBottom:11,fontFamily:"'JetBrains Mono',monospace"}}>Age: {computeAge(dob)} · auto-updates on your birthday</div>}
      {!dob&&<div style={{fontSize:11,color:T.mu,marginBottom:11}}>Your age updates automatically from your birthday.</div>}

      {/* Interests */}
      <div style={{fontSize:11,color:T.mu,textTransform:"uppercase",letterSpacing:.8,marginBottom:8,fontWeight:600}}>Interests ({ints.length}/6)</div>
      <div style={{display:"flex",gap:6,flexWrap:"wrap",marginBottom:16,maxHeight:200,overflowY:"auto"}}>{INTERESTS.map(i=><div key={i} onClick={()=>togInt(i)} style={{padding:"5px 12px",borderRadius:6,cursor:"pointer",fontSize:12,fontWeight:500,background:ints.includes(i)?`${AC}1a`:T.faint,border:`1px solid ${ints.includes(i)?AC+"44":T.b1}`,color:ints.includes(i)?AC:T.mu,transition:"all .12s"}}>{i}</div>)}</div>
    </>}

    {/* Social Links */}
    <div style={{fontSize:11,color:T.mu,textTransform:"uppercase",letterSpacing:.8,marginBottom:8,fontWeight:600}}>Social Links</div>
    {[{k:"instagram",ph:"@username"},{k:"twitter",ph:"@username"},{k:"tiktok",ph:"@username"},{k:"website",ph:"https://…"}].map(f=><input key={f.k} value={links[f.k]||""} onChange={e=>setLinks(l=>({...l,[f.k]:e.target.value}))} placeholder={`${f.k} ${f.ph}`} style={inp}/>)}

    {/* UID */}
    <div style={{padding:"11px 13px",background:T.faint,border:`1px solid ${T.b1}`,borderRadius:11,marginBottom:11}}>
      <div style={{fontSize:11,color:T.mu,marginBottom:4,textTransform:"uppercase",letterSpacing:.8,fontWeight:600}}>Your Unique ID</div>
      <div style={{fontFamily:"'JetBrains Mono',monospace",fontSize:16,fontWeight:700,color:AC,letterSpacing:2}}>#{me.short_id||shortId(me.id)}</div>
      <div style={{fontSize:11,color:T.mu,marginTop:3}}>📧 {me.email||"No email set"}</div>
    </div>
...
/* ── SETTINGS MODAL (app settings only — no profile fields) ── */
function SettingsModal({me,prefs,T,onClose,onSave,onSavePrefs,onEditPhoto,onShowBlocked,onLogout,onDelete,onQR}){
  const [tab,setTab]=useState("appearance");
  const [ok,setOk]=useState(false);const[logQ,setLogQ]=useState(false);
  const [delStep,setDelStep]=useState(0);const[delReason,setDelReason]=useState("");
  const [showPrivacy,setShowPrivacy]=useState(false);
  const isBizProfile=me.account_type==="business";
  const inp={width:"100%",padding:"11px 13px",background:T.inp,border:`1px solid ${T.b1}`,borderRadius:11,color:T.txt,fontSize:13,outline:"none",boxSizing:"border-box",marginBottom:11};
  const TABS=[{id:"appearance",label:"Appearance"},{id:"privacy",label:"Privacy"},{id:"account",label:"Account"}];

  const DEL_REASONS=["I don't use it anymore","Privacy concerns","Too many notifications","I found a better app","I want to start fresh","Other"];

  return<Overlay onBg={onClose} T={T} wide>
    <div style={{fontWeight:700,fontSize:18,color:T.txt,marginBottom:14}}>Settings</div>
    <div style={{display:"flex",gap:2,marginBottom:18,overflowX:"auto",paddingBottom:2}}>
      {TABS.map(t=><button key={t.id} onClick={()=>setTab(t.id)} style={{padding:"7px 13px",borderRadius:8,border:tab===t.id?`1px solid ${T.b1}`:"1px solid transparent",background:tab===t.id?T.faint:"transparent",color:tab===t.id?T.txt:T.mu,fontWeight:tab===t.id?600:400,fontSize:12,whiteSpace:"nowrap",transition:"all .12s"}}>{t.label}</button>)}
    </div>
    {tab==="appearance"&&<div>
      <SRow label="🌙 Dark Mode" val={prefs.dark} onChange={v=>onSavePrefs({...prefs,dark:v})} T={T}/>
    </div>}
    {tab==="privacy"&&<div style={{display:"flex",flexDirection:"column",gap:10}}>
      <button onClick={()=>{onClose();onShowBlocked();}} style={{display:"flex",alignItems:"center",gap:10,padding:"13px 14px",background:T.faint,border:`1px solid ${T.b1}`,borderRadius:11,width:"100%",color:T.txt,fontSize:14,fontWeight:500,textAlign:"left"}}><ShieldIcon/><div style={{flex:1}}><div>Blocked Users</div><div style={{fontSize:11,color:T.mu,marginTop:1}}>Manage people you have blocked</div></div><span style={{color:T.mu,fontSize:18}}>›</span></button>
      <button onClick={()=>setShowPrivacy(true)} style={{display:"flex",alignItems:"center",gap:10,padding:"13px 14px",background:T.faint,border:`1px solid ${T.b1}`,borderRadius:11,width:"100%",color:T.txt,fontSize:14,fontWeight:500,textAlign:"left"}}>
        <span style={{fontSize:16}}>📄</span>
        <div style={{flex:1}}><div>Privacy Policy</div><div style={{fontSize:11,color:T.mu,marginTop:1}}>How we handle your data</div></div>
        <span style={{color:T.mu,fontSize:18}}>›</span>
      </button>
      {showPrivacy&&<PrivacyPolicy T={T} onClose={()=>setShowPrivacy(false)}/>}
    </div>}
    {tab==="account"&&<div>
      <div style={{padding:"10px 13px",background:T.faint,border:`1px solid ${T.b1}`,borderRadius:9,marginBottom:8,fontSize:12,color:T.mu}}>Email: <strong style={{color:T.txt}}>{me.email}</strong></div>
      <div style={{padding:"10px 13px",background:T.faint,border:`1px solid ${T.b1}`,borderRadius:9,marginBottom:14,fontSize:12,color:T.mu}}>Member since <strong style={{color:T.txt}}>{new Date(me.created_at||Date.now()).toLocaleDateString()}</strong></div>

      {/* Change Email */}
      <ChangeEmailSection T={T} inp={inp}/>
      {/* Change Password */}
      <ChangePasswordSection T={T} inp={inp}/>

      <div style={{height:1,background:T.b1,marginBottom:14,marginTop:6}}/>
      {!logQ?<button onClick={()=>setLogQ(true)} style={{width:"100%",padding:"12px 0",background:"transparent",border:`1px solid ${T.b1}`,borderRadius:11,color:T.mu,fontWeight:600,fontSize:13,marginBottom:8}}>Log Out</button>
        :<div style={{background:T.faint,border:`1px solid ${T.b1}`,borderRadius:11,padding:"13px 14px",marginBottom:8}}><p style={{color:T.txt,fontSize:13,marginBottom:11}}>Log out of your account?</p><div style={{display:"flex",gap:7}}><button onClick={()=>{onClose();onLogout();}} style={{flex:1,padding:"9px 0",background:AC,borderRadius:9,color:"#fff",fontWeight:700,fontSize:13}}>Log Out</button><button onClick={()=>setLogQ(false)} style={{flex:1,padding:"9px 0",background:"transparent",border:`1px solid ${T.b1}`,borderRadius:9,color:T.mu,fontSize:13}}>Cancel</button></div></div>}

      {/* 3-step delete */}
      {delStep===0&&<button onClick={()=>setDelStep(1)} style={{width:"100%",padding:"12px 0",background:"transparent",border:"1px solid #7a303040",borderRadius:11,color:"#c06060",fontWeight:600,fontSize:13}}>Delete Account</button>}
      {delStep===1&&<div style={{background:"#7a303010",border:"1px solid #7a303030",borderRadius:11,padding:"14px"}}>
        <div style={{fontWeight:700,fontSize:14,color:"#c06060",marginBottom:4}}>Why are you leaving?</div>
        <div style={{fontSize:12,color:T.mu,marginBottom:12}}>Step 1 of 2 — Your feedback helps us improve</div>
        <div style={{display:"flex",flexDirection:"column",gap:6,marginBottom:14}}>
          {DEL_REASONS.map(r=><div key={r} onClick={()=>setDelReason(r)} style={{padding:"9px 12px",background:delReason===r?"#a0303018":T.faint,border:`1px solid ${delReason===r?"#c06060":"#7a303030"}`,borderRadius:8,cursor:"pointer",fontSize:13,color:delReason===r?"#c06060":T.mu,fontWeight:delReason===r?600:400,transition:"all .1s"}}>{r}</div>)}
        </div>
        <div style={{display:"flex",gap:7}}>
          <button disabled={!delReason} onClick={()=>setDelStep(2)} style={{flex:1,padding:"10px 0",background:delReason?"#a04040":"transparent",border:delReason?"none":`1px solid ${T.b1}`,borderRadius:9,color:delReason?"#fff":T.mu,fontWeight:700,fontSize:13}}>Next →</button>
          <button onClick={()=>{setDelStep(0);setDelReason("");}} style={{flex:1,padding:"10px 0",background:"transparent",border:`1px solid ${T.b1}`,borderRadius:9,color:T.mu,fontSize:13}}>Cancel</button>
        </div>
      </div>}
      {delStep===2&&<div style={{background:"#7a303010",border:"1px solid #c0404040",borderRadius:11,padding:"14px"}}>
        <div style={{fontWeight:700,fontSize:15,color:"#c06060",marginBottom:6}}>⚠️ Final confirmation</div>
        <div style={{fontSize:13,color:T.mu,marginBottom:4}}>Step 2 of 2</div>
        <p style={{fontSize:13,color:"#c06060",marginBottom:12,lineHeight:1.5}}>This will permanently delete your account, profile, all ratings, and messages. <strong>This cannot be undone.</strong></p>
        <div style={{display:"flex",gap:7}}>
          <button onClick={()=>{onClose();onDelete();}} style={{flex:1,padding:"10px 0",background:"#a04040",borderRadius:9,color:"#fff",fontWeight:700,fontSize:13}}>Delete Forever</button>
          <button onClick={()=>{setDelStep(0);setDelReason("");}} style={{flex:1,padding:"10px 0",background:"transparent",border:`1px solid ${T.b1}`,borderRadius:9,color:T.mu,fontSize:13}}>Cancel</button>
        </div>
      </div>}
    </div>}
...
function ScoreCardModal({profile,T,onClose}){
  ...
  useEffect(()=>{
    ...
    function drawShell(){
      // White background
      ctx.fillStyle="#f5f5fa";ctx.fillRect(0,0,W,H);
      // Top accent bar (tier gradient)
      const topBar=ctx.createLinearGradient(0,0,W,0);topBar.addColorStop(0,t.color);topBar.addColorStop(1,t.grad[1]);ctx.fillStyle=topBar;ctx.fillRect(0,0,W,10);
      // White card with soft shadow
      ctx.fillStyle="#ffffff";ctx.shadowColor="rgba(0,0,0,.09)";ctx.shadowBlur=32;ctx.shadowOffsetY=6;ctx.beginPath();ctx.roundRect(36,36,W-72,H-72,22);ctx.fill();ctx.shadowBlur=0;ctx.shadowOffsetY=0;
      // Card border
      ctx.strokeStyle=t.color+"28";ctx.lineWidth=1.5;ctx.beginPath();ctx.roundRect(36,36,W-72,H-72,22);ctx.stroke();
      // Logo — top-left
      ctx.textAlign="left";ctx.font="800 34px Inter,Arial,sans-serif";ctx.fillStyle="#111126";
      const hiW=ctx.measureText("High").width;ctx.fillText("High",76,100);
      ctx.font="300 34px Inter,Arial,sans-serif";ctx.fillStyle="#7b72e9";ctx.fillText("Enough",76+hiW+2,100);
      // Subtitle badge — top-right
      const badgeText=isBiz?`HighEnough · for Business`:`⭐ Personal Score Card`;
      ctx.fillStyle=t.color+"14";ctx.strokeStyle=t.color+"40";ctx.lineWidth=1;ctx.beginPath();ctx.roundRect(W-220,72,144,32,7);ctx.fill();ctx.stroke();
      ctx.textAlign="center";ctx.font="600 11px Inter,Arial,sans-serif";ctx.fillStyle=t.color;ctx.fillText(badgeText,W-148,93);
      // Divider
      ctx.strokeStyle="#e6e6f0";ctx.lineWidth=1;ctx.beginPath();ctx.moveTo(76,118);ctx.lineTo(W-76,118);ctx.stroke();
    }
    ...
    // ── Shared: name + handle ──
    function drawName(y1,y2){
      ctx.textAlign="center";ctx.font="bold 46px Inter,Arial,sans-serif";ctx.fillStyle="#111126";ctx.fillText(profile.name,W/2,y1);
      ctx.font="500 20px 'JetBrains Mono',monospace";ctx.fillStyle="#8888a8";ctx.fillText(profile.handle||"",W/2,y2);
    }

    // ── Shared: tier badge ──
    function drawTier(y){
      const tierLabel=`${t.emoji}  ${t.label.toUpperCase()}`;
      ctx.textAlign="center";ctx.font="700 22px Inter,Arial,sans-serif";
      const tlW=ctx.measureText(tierLabel).width+40,tlX=W/2-tlW/2;
      ctx.fillStyle=t.color+"16";ctx.strokeStyle=t.color+"45";ctx.lineWidth=1;
      ctx.beginPath();ctx.roundRect(tlX,y,tlW,40,9);ctx.fill();ctx.stroke();
      ctx.fillStyle=t.color;ctx.fillText(tierLabel,W/2,y+27);
    }

    // ── Shared: category bars ──
    function drawBars(bY){
      const bH=8,bGap=12,bW=(W-160-(cats.length-1)*bGap)/cats.length,startX=80;
      cats.forEach((c,i)=>{
        const v=cAvg(profile,c.id)/100,x=startX+i*(bW+bGap);
        ctx.fillStyle="#ebebf4";ctx.beginPath();ctx.roundRect(x,bY,bW,bH,4);ctx.fill();
        if(v>0){
          const bg2=ctx.createLinearGradient(x,0,x+bW,0);bg2.addColorStop(0,profile.color+"cc");bg2.addColorStop(1,t.color+"99");
          ctx.fillStyle=bg2;ctx.beginPath();ctx.roundRect(x,bY,bW*v,bH,4);ctx.fill();
        }
        ctx.font="600 18px Inter,Arial";ctx.fillStyle="#555570";ctx.textAlign="center";ctx.fillText(c.emoji,x+bW/2,bY+34);
        ctx.font="500 12px Inter,Arial";ctx.fillStyle="#9090b0";ctx.fillText(c.label,x+bW/2,bY+52);
      });
    }

    // ── Shared: UID row ──
    function drawUID(y1,y2){
      ctx.textAlign="center";ctx.font="500 12px 'JetBrains Mono',monospace";ctx.fillStyle="#aaaacc";ctx.fillText("UNIQUE ID",W/2,y1);
      ctx.font="800 38px 'JetBrains Mono',monospace";ctx.fillStyle=t.color;ctx.fillText(`#${profile.short_id||shortId(profile.id)}`,W/2,y2);
    }

    // ── Shared: footer box ──
    function drawFooter(fy,sub){
      ctx.fillStyle="#f0f0f8";ctx.strokeStyle="#e2e2ee";ctx.lineWidth=1;ctx.beginPath();ctx.roundRect(76,fy,W-152,120,14);ctx.fill();ctx.stroke();
      ctx.textAlign="center";ctx.font="800 28px Inter,Arial,sans-serif";ctx.fillStyle="#111126";
      const hiF=ctx.measureText("High").width;const lsx=W/2-(hiF+ctx.measureText("Enough").width+4)/2;
      ctx.textAlign="left";ctx.fillText("High",lsx,fy+50);
      ctx.font="300 28px Inter,Arial,sans-serif";ctx.fillStyle="#7b72e9";ctx.fillText("Enough",lsx+hiF+4,fy+50);
      ctx.textAlign="center";ctx.font="500 13px 'JetBrains Mono',monospace";ctx.fillStyle="#9090b0";ctx.fillText(sub,W/2,fy+78);
      ctx.font="500 11px 'JetBrains Mono',monospace";ctx.fillStyle=t.color+"aa";ctx.fillText(profileUrl,W/2,fy+102);
    }

    if(isBiz){
      drawShell();
      drawAvatar(W/2,252,78);
      drawName(378,410);
      // Sub-category badge below name — single occurrence
      const bizTypeLabel=BIZ_TYPES.find(b=>b.id===(profile.biz_type||"general"))?.label||"Business / Professional";
      const bizTypeEmoji=BIZ_TYPES.find(b=>b.id===(profile.biz_type||"general"))?.emoji||"💼";
      const subLabel=`${bizTypeEmoji} ${bizTypeLabel}`;
      ctx.textAlign="center";ctx.font="500 16px Inter,Arial,sans-serif";
      const slW=ctx.measureText(subLabel).width+28,slX=W/2-slW/2;
      ctx.fillStyle=t.color+"12";ctx.strokeStyle=t.color+"35";ctx.lineWidth=1;
      ctx.beginPath();ctx.roundRect(slX,416,slW,30,7);ctx.fill();ctx.stroke();
      ctx.fillStyle=t.color;ctx.fillText(subLabel,W/2,436);
      ctx.textAlign="center";ctx.font="900 108px 'JetBrains Mono',monospace";
      const sg=ctx.createLinearGradient(W/2-120,460,W/2+120,570);sg.addColorStop(0,t.grad[0]);sg.addColorStop(1,t.grad[1]);ctx.fillStyle=sg;ctx.fillText(sc!=null?fmtScore(sc):"—",W/2,570);
      ctx.font="600 18px Inter,Arial,sans-serif";ctx.fillStyle="#9090b0";ctx.fillText("Overall Score",W/2,598);
      drawTier(616);
      drawBars(674);
      drawUID(760,796);
      drawFooter(826,"HighEnough.in  ·  for Business");
    } else {
      // ── Personal card: clean, no overlapping elements ──
      const W=900,H=1260;
      canvas.width=W;canvas.height=H;

      // White background
      ctx.fillStyle="#f8f8fc";ctx.fillRect(0,0,W,H);

      // Subtle dot grid
      ctx.fillStyle=t.color+"10";
      for(let x=36;x<W;x+=40)for(let y=36;y<H;y+=40){ctx.beginPath();ctx.arc(x,y,1.2,0,Math.PI*2);ctx.fill();}

      // Top color band
      const topBand=ctx.createLinearGradient(0,0,W,0);
      topBand.addColorStop(0,t.grad[0]);topBand.addColorStop(1,t.grad[1]);
      ctx.fillStyle=topBand;ctx.fillRect(0,0,W,12);

      // White inner card
      ctx.fillStyle="#ffffff";ctx.shadowColor="rgba(60,40,120,.10)";ctx.shadowBlur=36;ctx.shadowOffsetY=6;
      ctx.beginPath();ctx.roundRect(48,48,W-96,H-96,24);ctx.fill();
      ctx.shadowBlur=0;ctx.shadowOffsetY=0;
      ctx.strokeStyle=t.color+"28";ctx.lineWidth=1.5;
      ctx.beginPath();ctx.roundRect(48,48,W-96,H-96,24);ctx.stroke();

      // Logo — top left
      ctx.textAlign="left";ctx.font="800 30px Inter,Arial,sans-serif";ctx.fillStyle="#111126";
      const hiW2=ctx.measureText("High").width;ctx.fillText("High",80,102);
      ctx.font="300 30px Inter,Arial,sans-serif";ctx.fillStyle="#7b72e9";ctx.fillText("Enough",80+hiW2+2,102);

      // "Personal Score Card" badge — top right
      ctx.fillStyle=t.color+"14";ctx.strokeStyle=t.color+"40";ctx.lineWidth=1;
      ctx.beginPath();ctx.roundRect(W-230,72,162,34,8);ctx.fill();ctx.stroke();
      ctx.textAlign="center";ctx.font="600 12px Inter,Arial,sans-serif";ctx.fillStyle=t.color;
      ctx.fillText("⭐ Personal Score Card",W-149,94);
      ...
      ctx.font="500 19px 'JetBrains Mono',monospace";ctx.fillStyle="#8888aa";ctx.fillText(profile.handle||"",W/2,428);

      // ── Score block — plain box, NO arc overlay ──
      ctx.fillStyle=t.color+"0e";ctx.strokeStyle=t.color+"30";ctx.lineWidth=1.5;
      ctx.beginPath();ctx.roundRect(80,452,W-160,120,16);ctx.fill();ctx.stroke();
      // Score label
      ctx.textAlign="center";ctx.font="500 14px Inter,Arial,sans-serif";ctx.fillStyle="#9090b0";ctx.fillText("OVERALL SCORE",W/2,484);
      // Score number — large, clear, no gradient bleed
      ctx.font="900 80px 'JetBrains Mono',monospace";ctx.fillStyle=t.color;ctx.fillText(sc!=null?fmtScore(sc):"—",W/2,556);

      // Tier badge row
      const {level:lvl}=tierLevel(sc??0,isBiz);
      const tierStr=`${t.emoji}  ${t.label.toUpperCase()}${sc&&sc>0?" · L"+lvl:""}`;
      ctx.textAlign="center";ctx.font="700 22px Inter,Arial,sans-serif";
      const tlW2=ctx.measureText(tierStr).width+48,tlX2=W/2-tlW2/2;
      ctx.fillStyle=t.color+"16";ctx.strokeStyle=t.color+"44";ctx.lineWidth=1;
      ctx.beginPath();ctx.roundRect(tlX2,592,tlW2,42,21);ctx.fill();ctx.stroke();
      ctx.fillStyle=t.color;ctx.fillText(tierStr,W/2,619);

      // Ratings count strip
      const rCount2=(profile.ratings||[]).length;
      ctx.fillStyle="#f2f2fa";ctx.strokeStyle="#e4e4f0";ctx.lineWidth=1;
      ctx.beginPath();ctx.roundRect(80,652,W-160,50,10);ctx.fill();ctx.stroke();
      ctx.textAlign="center";ctx.font="600 14px Inter,Arial,sans-serif";ctx.fillStyle="#7070a0";
      ctx.fillText(`Rated by ${rCount2} ${rCount2===1?"person":"people"}  ·  ${n} rating${n!==1?"s":""}`,W/2,683);

      // Category scores — clean row of boxes
      const catGap=10,catW=(W-160-(cats.length-1)*catGap)/cats.length,catY=720,catH=116,catX0=80;
      cats.forEach((c,i)=>{
        const v=cAvg(profile,c.id),x=catX0+i*(catW+catGap);
        // Box
        ctx.fillStyle="#f9f9fd";ctx.strokeStyle="#e4e4f0";ctx.lineWidth=1;
        ctx.beginPath();ctx.roundRect(x,catY,catW,catH,10);ctx.fill();ctx.stroke();
        // Color accent top bar
        const cg=ctx.createLinearGradient(x,catY,x+catW,catY);cg.addColorStop(0,profile.color+"cc");cg.addColorStop(1,t.color+"99");
        ctx.fillStyle=cg;
        ctx.beginPath();
        // Manually draw top-rounded rect for top bar
        const r=10,bh=6;
        ctx.moveTo(x+r,catY);ctx.lineTo(x+catW-r,catY);ctx.arcTo(x+catW,catY,x+catW,catY+r,r);
        ctx.lineTo(x+catW,catY+bh);ctx.lineTo(x,catY+bh);ctx.lineTo(x,catY+r);
        ctx.arcTo(x,catY,x+r,catY,r);ctx.closePath();ctx.fill();
        // Emoji
        ctx.font="20px Inter,Arial";ctx.textAlign="center";ctx.fillText(c.emoji,x+catW/2,catY+38);
        // Score value
        ctx.font="700 17px 'JetBrains Mono',monospace";ctx.fillStyle=v>0?t.color:"#bbbbcc";
        ctx.fillText(v>0?Math.round(v):"—",x+catW/2,catY+64);
        // Label
        ctx.font="500 10px Inter,Arial";ctx.fillStyle="#8888a8";ctx.fillText(c.label,x+catW/2,catY+84);
        // Progress bar
        ctx.fillStyle="#eaeaf4";ctx.beginPath();ctx.roundRect(x+8,catY+catH-14,catW-16,5,3);ctx.fill();
        if(v>0){ctx.fillStyle=cg;ctx.beginPath();ctx.roundRect(x+8,catY+catH-14,(catW-16)*(v/100),5,3);ctx.fill();}
      });

      // UID
      ctx.textAlign="center";ctx.font="500 11px 'JetBrains Mono',monospace";ctx.fillStyle="#aaaacc";ctx.fillText("UNIQUE ID",W/2,876);
      ctx.font="800 40px 'JetBrains Mono',monospace";ctx.fillStyle=t.color;ctx.fillText(`#${profile.short_id||shortId(profile.id)}`,W/2,924);

      // Divider
      ctx.strokeStyle="#e6e6f2";ctx.lineWidth=1;ctx.beginPath();ctx.moveTo(80,946);ctx.lineTo(W-80,946);ctx.stroke();

      // Score breakdown row (category averages listed)
      const catNames=cats.map(c=>c.label);
      const colW2=(W-160)/cats.length;
      ctx.font="600 11px Inter,Arial,sans-serif";ctx.fillStyle="#9090b0";
      cats.forEach((c,i)=>{
        const v=cAvg(profile,c.id);
        const cx=80+i*colW2+colW2/2;
        ctx.textAlign="center";ctx.fillStyle=v>0?t.color+"cc":"#ccccdd";
        ctx.font="700 15px 'JetBrains Mono',monospace";ctx.fillText(v>0?Math.round(v)+"":"—",cx,976);
        ctx.font="500 10px Inter,Arial";ctx.fillStyle="#9090b0";ctx.fillText(c.label,cx,993);
      });

      // Footer
      ctx.fillStyle="#f0f0f8";ctx.strokeStyle="#e0e0ee";ctx.lineWidth=1;
      ctx.beginPath();ctx.roundRect(80,1014,W-160,120,14);ctx.fill();ctx.stroke();
      ctx.textAlign="left";ctx.font="800 28px Inter,Arial,sans-serif";ctx.fillStyle="#111126";
      const hiF2=ctx.measureText("High").width;
      const lsx2=W/2-(hiF2+(()=>{const tmp=ctx.measureText;ctx.font="300 28px Inter,Arial,sans-serif";const w=ctx.measureText("Enough").width;ctx.font="800 28px Inter,Arial,sans-serif";return w;})()+4)/2;
      ctx.fillText("High",lsx2,1060);
      ctx.font="300 28px Inter,Arial,sans-serif";ctx.fillStyle="#7b72e9";ctx.fillText("Enough",lsx2+hiF2+4,1060);
      ctx.textAlign="center";ctx.font="500 13px 'JetBrains Mono',monospace";ctx.fillStyle="#9090b0";ctx.fillText("highenough.in  ·  Rate · Rise · Repeat",W/2,1090);
      ctx.font="500 11px 'JetBrains Mono',monospace";ctx.fillStyle=t.color+"99";ctx.fillText(profileUrl,W/2,1116);
  ...
  const allTiers=getTiers(profile);
  const tIdx=allTiers.indexOf(t);
  const next=allTiers[tIdx+1];
  const pct=tierPct(sc??0,isBiz);
  const isFama=t.label==="HighEnough";

  return<div onClick={e=>e.target===e.currentTarget&&onClose()} style={{position:"fixed",inset:0,zIndex:400,background:T.ov,backdropFilter:"blur(16px)",WebkitBackdropFilter:"blur(16px)",display:"flex",flexDirection:"column",overflowY:"auto"}}>
    <canvas ref={canvasRef} style={{display:"none"}}/>

    {/* Close */}
    <button onClick={onClose} style={{position:"fixed",top:18,right:18,width:36,height:36,borderRadius:"50%",background:T.faint,border:`1px solid ${T.b2}`,color:T.txt,display:"flex",alignItems:"center",justifyContent:"center",fontSize:18,zIndex:10}}>✕</button>

    <div style={{padding:"24px 18px 32px",maxWidth:480,margin:"0 auto",width:"100%"}}>

      {/* ── Tier hero banner ── */}
      <div style={{position:"relative",borderRadius:22,overflow:"hidden",marginBottom:16,background:`linear-gradient(160deg,${t.grad[0]},${t.grad[1]})`,padding:"24px 20px 20px"}}>
        <div style={{position:"absolute",top:-40,right:-40,width:200,height:200,borderRadius:"50%",background:`radial-gradient(circle,${t.color}30,transparent 70%)`,pointerEvents:"none"}}/>
        <div style={{position:"absolute",top:16,right:16,fontSize:10,fontWeight:700,color:"rgba(255,255,255,.55)",letterSpacing:".1em",textTransform:"uppercase"}}>{isBiz?"HighEnough · for Business":"HighEnough · Personal"}</div>

        <div style={{display:"flex",alignItems:"center",gap:14,marginBottom:18}}>
          <div style={{width:64,height:64,borderRadius:"50%",border:"2px solid rgba(255,255,255,.4)",background:"rgba(255,255,255,.12)",overflow:"hidden",flexShrink:0,display:"flex",alignItems:"center",justifyContent:"center",fontWeight:800,fontSize:22,color:"#fff"}}>
            {profile.photo?<img src={profile.photo} alt="" style={{width:"100%",height:"100%",objectFit:"cover"}}/>:ini(profile.name)}
          </div>
          <div>
            <div style={{fontWeight:800,fontSize:20,color:"#fff",letterSpacing:"-.3px"}}>{profile.name}</div>
            <div style={{fontFamily:"'JetBrains Mono',monospace",fontSize:11,color:"rgba(255,255,255,.55)",marginTop:3}}>{profile.handle} · #{profile.short_id||shortId(profile.id)}</div>
          </div>
        </div>

        <div style={{display:"flex",alignItems:"flex-end",gap:12,marginBottom:16}}>
          <div style={{fontFamily:"'JetBrains Mono',monospace",fontSize:72,fontWeight:900,color:"#fff",lineHeight:1}}>{sc!=null?fmtScore(sc):"—"}</div>
          <div style={{paddingBottom:10}}>
            <div style={{fontSize:11,color:"rgba(255,255,255,.5)",marginBottom:3}}>pts</div>
            <span style={{background:"rgba(255,255,255,.2)",borderRadius:6,padding:"3px 10px",fontSize:13,fontWeight:700,color:"#fff",fontFamily:"'JetBrains Mono',monospace"}}>{t.emoji} {t.label}</span>
          </div>
        </div>

        <div>
          <div style={{display:"flex",justifyContent:"space-between",marginBottom:6,fontSize:11,color:"rgba(255,255,255,.5)"}}>
            <span>{t.label}</span>
            <span>{isFama?"Max tier 👑":next?`→ ${next.label} (${next.min} pts)`:""}</span>
          </div>
          <div style={{height:6,background:"rgba(255,255,255,.2)",borderRadius:99,overflow:"hidden"}}>
            <div style={{width:`${isFama?100:pct*100}%`,height:"100%",background:"rgba(255,255,255,.85)",borderRadius:99,transition:"width 1.2s cubic-bezier(.4,0,.2,1)"}}/>
          </div>
        </div>
      </div>
      ...
      <div style={{display:"flex",gap:10,marginBottom:16}}>
        {[{label:"Ratings",val:n,color:col},{label:"Followers",val:fmtCount(profile.followers_count||0),color:col},{label:"Following",val:fmtCount(profile.following_count||0),color:T.mu}].map(s=><div key={s.label} style={{flex:1,background:T.card,border:`1px solid ${T.b1}`,borderRadius:14,padding:"12px 0",textAlign:"center"}}>
          <div style={{fontFamily:"'JetBrains Mono',monospace",fontSize:20,fontWeight:800,color:s.color}}>{s.val}</div>
          <div style={{fontSize:10,color:T.mu,marginTop:3,letterSpacing:".04em"}}>{s.label.toUpperCase()}</div>
        </div>)}
      </div>

      {/* ── Category breakdown ── */}
      {n>0&&<div style={{background:T.card,border:`1px solid ${T.b1}`,borderRadius:18,padding:"16px",marginBottom:16}}>
        <div style={{fontWeight:700,fontSize:12,color:T.mu,marginBottom:6,letterSpacing:".06em",textTransform:"uppercase"}}>{isBiz?"Review Breakdown":"Rating Breakdown"}</div>
        <div style={{fontSize:11,color:T.mu,marginBottom:12,lineHeight:1.5}}>Score = sum of each rater's average. Each rater adds up to 100 pts. No cap — grows with every rater.</div>
        {cats.map(c=>{const v=cAvg(profile,c.id);return<div key={c.id} style={{marginBottom:12}}>
          <div style={{display:"flex",justifyContent:"space-between",marginBottom:4}}>
            <span style={{fontSize:12,color:T.mu,fontWeight:500}}>{c.emoji} {c.label}</span>
            <span style={{fontFamily:"'JetBrains Mono',monospace",fontSize:12,color:v>=80?"#4ade80":v>=50?col:T.mu,fontWeight:700}}>{v}/100</span>
          </div>
          <div style={{height:5,background:T.b1,borderRadius:99,overflow:"hidden"}}>
            <div style={{width:`${v}%`,height:"100%",background:`linear-gradient(90deg,${col}dd,${col}88)`,borderRadius:99,transition:"width 1s ease"}}/>
          </div>
        </div>;})}
        <div style={{marginTop:8,padding:"8px 10px",background:`${col}0c`,borderRadius:8,fontSize:11,color:T.mu,fontFamily:"'JetBrains Mono',monospace",display:"flex",justifyContent:"space-between"}}>
          <span>Avg per category:</span>
          <span style={{fontWeight:700,color:col}}>{cats.reduce((s,c)=>s+cAvg(profile,c.id),0)} / {cats.length*100} pts</span>
        </div>
      </div>}

      {/* ── All tiers — visual roadmap ── */}
      <div style={{background:T.card,border:`1px solid ${T.b1}`,borderRadius:18,padding:"16px",marginBottom:16}}>
        <div style={{fontWeight:700,fontSize:12,color:T.mu,marginBottom:14,letterSpacing:".06em",textTransform:"uppercase"}}>Tier Roadmap</div>
        <div style={{display:"flex",flexDirection:"column",gap:8}}>
          {allTiers.map((tier,i)=>{
            const isActive=t.label===tier.label;
            const isPast=allTiers.indexOf(t)>i;
            return<div key={tier.label} style={{display:"flex",alignItems:"center",gap:10,padding:"8px 10px",borderRadius:10,background:isActive?`${tier.color}18`:"transparent",border:isActive?`1px solid ${tier.color}40`:`1px solid transparent`,transition:"all .2s"}}>
              <span style={{fontSize:16,opacity:isPast||isActive?1:.35}}>{tier.emoji}</span>
              <div style={{flex:1}}>
                <div style={{fontWeight:isActive?700:500,fontSize:13,color:isActive?tier.color:isPast?T.mu:T.b2}}>{tier.label}</div>
                <div style={{fontSize:10,color:T.mu,opacity:.7,marginTop:1,fontFamily:"'JetBrains Mono',monospace"}}>{tier.max===Infinity?`${tier.min}+ pts`:`${tier.min}–${tier.max} pts`}</div>
              </div>
              {isActive&&<div style={{fontSize:9,fontWeight:700,color:tier.color,background:`${tier.color}20`,borderRadius:4,padding:"2px 7px",letterSpacing:".06em"}}>YOU</div>}
              {isPast&&<div style={{fontSize:14,color:tier.color}}>✓</div>}
            </div>;
          })}
        </div>
      </div>
      ...
      <div style={{display:"flex",gap:10}}>
        <button onClick={shareCard} style={{flex:1,padding:"14px 0",background:`linear-gradient(135deg,${col}e0,${col}80)`,borderRadius:14,color:"#fff",fontWeight:700,fontSize:14,display:"flex",alignItems:"center",justifyContent:"center",gap:8,boxShadow:`0 6px 20px ${col}40`}}>
...
/* ── REPORT MODAL ── */
function ReportModal({target,T,onClose,onSubmit}){
  const [reason,setReason]=useState(null);const[alsoBlock,setAlsoBlock]=useState(true);const[done,setDone]=useState(false);
  if(done)return<Overlay onBg={onClose} T={T} bottom><div style={{textAlign:"center",padding:"16px 0"}}><div style={{fontSize:44,marginBottom:14}}>✅</div><div style={{fontWeight:700,fontSize:17,color:T.txt,marginBottom:8}}>Report submitted</div><p style={{fontSize:13,color:T.mu,marginBottom:20,lineHeight:1.6}}>Thanks for keeping HighEnough safe.{alsoBlock?` ${target.name} has been blocked.`:""}</p><button onClick={onClose} style={{width:"100%",padding:"12px 0",background:T.faint,border:`1px solid ${T.b1}`,borderRadius:11,color:T.txt,fontWeight:600}}>Done</button></div></Overlay>;
  return<Overlay onBg={onClose} T={T} bottom>
    <div style={{fontWeight:700,fontSize:16,color:T.txt,marginBottom:14}}>Report {target.name}</div>
    <div style={{display:"flex",flexDirection:"column",gap:7,marginBottom:16}}>
      {REPORT_REASONS.map(r=><div key={r.id} onClick={()=>setReason(r.id)} style={{display:"flex",alignItems:"center",gap:12,padding:"11px 13px",background:reason===r.id?`${AC}10`:T.faint,border:`1px solid ${reason===r.id?AC+"40":T.b1}`,borderRadius:10,cursor:"pointer",transition:"all .12s"}}>
        <div style={{width:18,height:18,borderRadius:"50%",border:`2px solid ${reason===r.id?AC:T.b2}`,display:"flex",alignItems:"center",justifyContent:"center",flexShrink:0}}>{reason===r.id&&<div style={{width:9,height:9,borderRadius:"50%",background:AC}}/>}</div>
        <div><div style={{fontSize:13,fontWeight:600,color:T.txt}}>{r.label}</div><div style={{fontSize:11,color:T.mu,marginTop:1}}>{r.desc}</div></div>
      </div>)}
    </div>
    <div onClick={()=>setAlsoBlock(!alsoBlock)} style={{display:"flex",alignItems:"center",gap:11,padding:"11px 13px",background:T.faint,border:`1px solid ${T.b1}`,borderRadius:10,cursor:"pointer",marginBottom:14}}>
      <div style={{width:18,height:18,borderRadius:4,border:`2px solid ${alsoBlock?AC:T.b2}`,background:alsoBlock?AC:"transparent",display:"flex",alignItems:"center",justifyContent:"center",flexShrink:0,transition:"all .12s"}}>{alsoBlock&&<svg width="10" height="10" viewBox="0 0 10 10" fill="none"><polyline points="1.5,5 4,7.5 8.5,2.5" stroke="#fff" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"/></svg>}</div>
      <div><div style={{fontSize:13,fontWeight:500,color:T.txt}}>Also block this person</div><div style={{fontSize:11,color:T.mu,marginTop:1}}>They won't see or rate you</div></div>
    </div>
    <button onClick={()=>{if(!reason)return;onSubmit(target.id,reason,alsoBlock);setDone(true);}} disabled={!reason} style={{width:"100%",padding:"13px 0",background:reason?"#a04040":"transparent",border:reason?"none":`1px solid ${T.b1}`,borderRadius:11,color:reason?"#fff":T.mu,fontWeight:700,fontSize:14,display:"flex",alignItems:"center",justifyContent:"center",gap:7}}><FlagIcon/>Submit Report</button>
  </Overlay>;
}

/* ── BLOCKED LIST ── */
function BlockedListPanel({blocked,profiles,T,onClose,onUnblock}){
  const bp=profiles.filter(p=>blocked.includes(p.id));
  return<Overlay onBg={onClose} T={T} bottom>
    <div style={{fontWeight:700,fontSize:17,color:T.txt,marginBottom:18}}>Blocked Users</div>
    {bp.length===0?<div style={{textAlign:"center",padding:"32px 0",color:T.mu}}><div style={{fontWeight:500}}>No blocked users</div></div>
      :<div style={{display:"flex",flexDirection:"column",gap:8}}>{bp.map(p=><div key={p.id} style={{display:"flex",alignItems:"center",gap:11,padding:"11px 13px",background:T.faint,border:`1px solid ${T.b1}`,borderRadius:12}}>
        <Ava p={p} size={42} T={T}/><div style={{flex:1}}><div style={{fontWeight:600,fontSize:14,color:T.txt}}>{p.name}</div><div style={{fontFamily:"'JetBrains Mono',monospace",fontSize:10,color:T.mu}}>{p.handle}</div></div>
        <button onClick={()=>onUnblock(p.id)} style={{padding:"7px 14px",background:"transparent",border:`1px solid ${T.b2}`,borderRadius:8,color:T.mu,fontSize:12,fontWeight:600}}>Unblock</button>
      </div>)}</div>}
  </Overlay>;
}

/* ── NOTIFS PANEL ── */
function NotifsPanel({notifs,profiles,T,onClose,onMark,onView}){
  return<div onClick={e=>e.target===e.currentTarget&&onClose()} style={{position:"fixed",inset:0,zIndex:250,background:T.ov,backdropFilter:"blur(10px)"}}>
    <div style={{position:"absolute",top:0,right:0,bottom:0,width:"min(360px,100vw)",background:T.surf,borderLeft:`1px solid ${T.b1}`,display:"flex",flexDirection:"column"}}>
      <div style={{padding:"18px 16px 12px",borderBottom:`1px solid ${T.b1}`,display:"flex",alignItems:"center",justifyContent:"space-between",flexShrink:0}}>
        <div style={{fontWeight:700,fontSize:17,color:T.txt}}>Notifications</div>
        <div style={{display:"flex",gap:8,alignItems:"center"}}>
          {notifs.some(n=>!n.read)&&<button onClick={()=>onMark("all")} style={{fontSize:11,color:AC,background:`${AC}18`,border:`1px solid ${AC}30`,borderRadius:7,padding:"5px 10px",fontWeight:600}}>Mark all read</button>}
          <button onClick={onClose} style={{background:T.faint,border:`1px solid ${T.b1}`,color:T.mu,width:26,height:26,borderRadius:"50%",display:"flex",alignItems:"center",justifyContent:"center"}}><XIcon/></button>
        </div>
      </div>
      <div style={{flex:1,overflowY:"auto"}}>
        {notifs.length===0&&<div style={{textAlign:"center",padding:"60px 20px",color:T.mu}}><div style={{fontWeight:500,marginTop:12}}>No notifications yet</div></div>}
        {notifs.map((n,i)=>{const actor=profiles.find(p=>p.id===n.actorId);const icons={rating:"⭐",edit:"✏️",follow:"👤",tier:"🏆"};
          const scoreText=n.score!=null?` (${n.score} pts)`:"";
          return<div key={i} onClick={()=>{onMark(i);if(actor)onView(actor);onClose();}} style={{display:"flex",gap:11,padding:"13px 16px",borderBottom:`1px solid ${T.b1}`,background:n.read?"transparent":T.faint,cursor:"pointer"}} onMouseEnter={e=>e.currentTarget.style.background=T.faint} onMouseLeave={e=>e.currentTarget.style.background=n.read?"transparent":T.faint}>
            <div style={{position:"relative",flexShrink:0}}><Ava p={actor||{name:"?",color:AC}} size={42} T={T}/><div style={{position:"absolute",bottom:-2,right:-2,width:18,height:18,borderRadius:"50%",background:T.surf,display:"flex",alignItems:"center",justifyContent:"center",fontSize:10,border:`1px solid ${T.b1}`}}>{icons[n.type]||"📢"}</div></div>
            <div style={{flex:1}}><div style={{fontSize:13,color:T.txt,lineHeight:1.4}}><strong>{actor?.name||"Someone"}</strong> {n.text}{scoreText&&<span style={{fontFamily:"'JetBrains Mono',monospace",color:AC,fontWeight:700}}>{scoreText}</span>}</div><div style={{fontFamily:"'JetBrains Mono',monospace",fontSize:10,color:T.mu,marginTop:2}}>{ago(n.ts)}</div></div>
            {!n.read&&<div style={{width:7,height:7,borderRadius:"50%",background:AC,flexShrink:0,marginTop:5}}/>}
          </div>;})}
      </div>
    </div>
  </div>;
...
/* ── ADMIN ── */
const ADMIN_CODE_VAL="HE2025";
function AdminLock({T,onUnlock,onClose}){
  const [code,setCode]=useState("");const[err,setErr]=useState(false);
  function tryUnlock(){if(code===ADMIN_CODE_VAL){onUnlock();}else{setErr(true);setCode("");setTimeout(()=>setErr(false),1200);}}
  return<Overlay onBg={onClose} T={T}><div style={{textAlign:"center",padding:"8px 0"}}>
    <div style={{fontSize:36,marginBottom:12}}>🔐</div>
    <div style={{fontWeight:700,fontSize:17,color:T.txt,marginBottom:20}}>Admin Access</div>
    <input type="password" value={code} onChange={e=>setCode(e.target.value)} onKeyDown={e=>e.key==="Enter"&&tryUnlock()} placeholder="Admin code" style={{width:"100%",padding:"13px 14px",background:T.inp,border:`1px solid ${err?"#c06060":T.b1}`,borderRadius:12,color:T.txt,fontSize:16,outline:"none",textAlign:"center",letterSpacing:"0.2em",boxSizing:"border-box",marginBottom:8}}/>
    {err&&<div style={{fontSize:12,color:"#c06060",marginBottom:8}}>Incorrect code</div>}
    <button onClick={tryUnlock} style={{width:"100%",padding:"13px 0",background:`linear-gradient(135deg,${AC}e0,${AC}90)`,borderRadius:12,color:"#fff",fontWeight:700,fontSize:14,marginTop:4}}>Unlock</button>
  </div></Overlay>;
}

function AdminPanel({profiles,reports,blocked,T,onClose,onDeleteProfile,onClearRatings,onExport}){
  const [tab,setTab]=useState("overview");const[search,setSearch]=useState("");const[confirmDel,setConfirmDel]=useState(null);
  const totalRatings=profiles.reduce((s,p)=>s+(p.ratings||[]).length,0);
  const filtered=profiles.filter(p=>!search||p.name.toLowerCase().includes(search.toLowerCase())||p.handle.toLowerCase().includes(search.toLowerCase()));
  const TABS=[{id:"overview",label:"Overview"},{id:"users",label:"Users"},{id:"reports",label:`Reports${reports.length?` (${reports.length})`:""}`},{id:"export",label:"Export"}];
  return<Overlay onBg={onClose} T={T} wide>
    <div style={{display:"flex",alignItems:"center",gap:10,marginBottom:16}}><span style={{fontSize:20}}>👑</span><div style={{flex:1}}><div style={{fontWeight:700,fontSize:17,color:T.txt}}>Admin Panel</div><div style={{fontFamily:"'JetBrains Mono',monospace",fontSize:10,color:T.mu}}>HighEnough · {profiles.length} users</div></div></div>
    <div style={{display:"flex",gap:4,marginBottom:18,background:T.faint,borderRadius:10,padding:3}}>
      {TABS.map(t=><button key={t.id} onClick={()=>setTab(t.id)} style={{flex:1,padding:"7px 0",borderRadius:8,background:tab===t.id?T.card:"transparent",color:tab===t.id?T.txt:T.mu,fontWeight:tab===t.id?600:400,fontSize:11,transition:"all .12s",border:tab===t.id?`1px solid ${T.b1}`:"1px solid transparent"}}>{t.label}</button>)}
    </div>
    {tab==="overview"&&<div>{[{label:"Total Users",val:profiles.length,color:AC},{label:"Total Ratings",val:totalRatings,color:"#10a37f"},{label:"Reports",val:reports.length,color:"#c06060"},{label:"Blocks",val:blocked.length,color:"#c08a2e"}].map(s=><div key={s.label} style={{display:"flex",alignItems:"center",justifyContent:"space-between",padding:"12px 14px",background:T.faint,border:`1px solid ${T.b1}`,borderRadius:11,marginBottom:8}}><span style={{fontSize:13,color:T.mu,fontWeight:500}}>{s.label}</span><span style={{fontFamily:"'JetBrains Mono',monospace",fontSize:18,fontWeight:700,color:s.color}}>{s.val}</span></div>)}</div>}
    {tab==="users"&&<div>
      <input value={search} onChange={e=>setSearch(e.target.value)} placeholder="Search users…" style={{width:"100%",padding:"10px 13px",background:T.inp,border:`1px solid ${T.b1}`,borderRadius:10,color:T.txt,fontSize:13,outline:"none",marginBottom:12,boxSizing:"border-box"}}/>
      <div style={{maxHeight:360,overflowY:"auto",display:"flex",flexDirection:"column",gap:7}}>
        {filtered.map(p=>{const sc=pScore(p);const isBizP=p.account_type==="business";const t=tierOf(sc??0,isBizP);return<div key={p.id} style={{display:"flex",alignItems:"center",gap:10,padding:"10px 12px",background:T.faint,border:`1px solid ${T.b1}`,borderRadius:10}}>
          <Ava p={p} size={38} T={T}/><div style={{flex:1,minWidth:0}}><div style={{fontWeight:600,fontSize:13,color:T.txt}}>{p.name}</div><div style={{fontFamily:"'JetBrains Mono',monospace",fontSize:10,color:T.mu}}>{p.handle} · #{p.short_id||shortId(p.id)}</div><TierBadge sc={sc} size="sm" isBiz={isBizP}/></div>
          <div style={{textAlign:"right",flexShrink:0}}><div style={{fontFamily:"'JetBrains Mono',monospace",fontSize:13,fontWeight:700,color:t.color}}>{sc!=null?fmtScore(sc):"—"}</div><div style={{display:"flex",gap:4,marginTop:5,justifyContent:"flex-end"}}>
            <button onClick={()=>onClearRatings(p.id)} style={{padding:"3px 7px",background:"transparent",border:`1px solid ${T.b2}`,borderRadius:5,color:T.mu,fontSize:10}}>Clear</button>
            {confirmDel===p.id?<><button onClick={()=>{onDeleteProfile(p.id);setConfirmDel(null);}} style={{padding:"3px 7px",background:"#a04040",borderRadius:5,color:"#fff",fontSize:10,fontWeight:700}}>✓</button><button onClick={()=>setConfirmDel(null)} style={{padding:"3px 7px",background:"transparent",border:`1px solid ${T.b1}`,borderRadius:5,color:T.mu,fontSize:10}}>✕</button></>:<button onClick={()=>setConfirmDel(p.id)} style={{padding:"3px 7px",background:"#a0303018",border:"1px solid #a0303030",borderRadius:5,color:"#c06060",fontSize:10}}>Del</button>}
          </div></div>
        </div>;})}
      </div>
    </div>}
    {tab==="reports"&&<div>
      {reports.length===0?<div style={{textAlign:"center",padding:"32px 0",color:T.mu}}>No reports yet</div>
        :<div style={{display:"flex",flexDirection:"column",gap:8,maxHeight:400,overflowY:"auto"}}>{reports.map((r,i)=>{const target=profiles.find(p=>p.id===r.targetId);const reason=REPORT_REASONS.find(x=>x.id===r.reasonId);return<div key={i} style={{padding:"11px 13px",background:T.faint,border:"1px solid #a0303025",borderRadius:11}}><div style={{display:"flex",justifyContent:"space-between",marginBottom:4}}><span style={{fontSize:12,fontWeight:600,color:"#c07070"}}>{reason?.label||r.reasonId}</span><span style={{fontFamily:"'JetBrains Mono',monospace",fontSize:10,color:T.mu}}>{new Date(r.ts).toLocaleDateString()}</span></div><div style={{fontSize:12,color:T.mu}}>Reported: <strong style={{color:T.txt}}>{target?.name||r.targetId}</strong></div></div>;})}
        </div>}
    </div>}
    {tab==="export"&&<div>
      {[{label:"Export All Data",fn:()=>onExport("all")},{label:"Export Profiles",fn:()=>onExport("profiles")},{label:"Export Reports",fn:()=>onExport("reports")}].map(e=><div key={e.label} style={{display:"flex",alignItems:"center",justifyContent:"space-between",padding:"13px 14px",background:T.faint,border:`1px solid ${T.b1}`,borderRadius:11,marginBottom:8}}><span style={{fontSize:13,fontWeight:500,color:T.txt}}>{e.label}</span><button onClick={e.fn} style={{padding:"7px 14px",background:`${AC}18`,border:`1px solid ${AC}30`,borderRadius:8,color:AC,fontSize:12,fontWeight:600,marginLeft:12}}>Export</button></div>)}
    </div>}
  </Overlay>;
}
...
══════════════════════════════════════ */
function PublicProfilePage({profile,onJoin,onClose}){
  const isBiz=profile.account_type==="business";
  const cats=getCats(profile);
  const sc=pScore(profile),n=(profile.ratings||[]).length,t=tierOf(sc??0,isBiz);
  ...
  // Store target in sessionStorage so after login the app re-opens this profile
  useEffect(()=>{
    try{sessionStorage.setItem("he_pending_profile",JSON.stringify({short_id:profile.short_id||shortId(profile.id),handle:profile.handle||""}));}catch{}
  },[profile.id]);

  function copyLink(){navigator.clipboard?.writeText(url);setCp(true);setTimeout(()=>setCp(false),2000);}
  function shareLink(){if(navigator.share)navigator.share({title:`${profile.name} on HighEnough`,text:`Rate ${profile.name} on HighEnough 👉 ${url}`,url});else copyLink();}

  return<div style={{minHeight:"100vh",background:DK.bg,color:DK.txt,fontFamily:"'Inter',sans-serif",display:"flex",flexDirection:"column"}}>
    {/* Top bar */}
    <div style={{background:DK.nav,borderBottom:`1px solid ${DK.b1}`,padding:"12px 18px",display:"flex",alignItems:"center",justifyContent:"space-between",position:"sticky",top:0,zIndex:10,backdropFilter:"blur(20px)",WebkitBackdropFilter:"blur(20px)"}}>
      <div style={{fontWeight:800,fontSize:20,letterSpacing:"-1.5px"}}>High<span style={{color:AC,fontWeight:300}}>Enough</span></div>
      <div style={{display:"flex",gap:8}}>
        <button onClick={onJoin} style={{padding:"8px 14px",background:"rgba(255,255,255,.08)",border:"1px solid rgba(255,255,255,.14)",borderRadius:9,color:"rgba(255,255,255,.8)",fontWeight:600,fontSize:13}}>Log In</button>
        <button onClick={onJoin} style={{padding:"8px 16px",background:`linear-gradient(135deg,${AC}e0,${AC}80)`,borderRadius:9,color:"#fff",fontWeight:700,fontSize:13}}>Sign Up</button>
      </div>
    </div>

    <div style={{flex:1,overflowY:"auto",padding:"24px 18px 32px",maxWidth:480,margin:"0 auto",width:"100%"}}>
      {/* Profile header */}
      <div style={{textAlign:"center",marginBottom:24}}>
        <div style={{display:"inline-block",position:"relative",marginBottom:12}}>
          <Ava p={profile} size={96} T={DK} ring/>
          {isBiz&&<div style={{position:"absolute",bottom:-2,right:-2,background:AC,borderRadius:"50%",width:26,height:26,display:"flex",alignItems:"center",justifyContent:"center",fontSize:13,border:`2px solid ${DK.bg}`}}>🏢</div>}
        </div>
        <div style={{fontWeight:800,fontSize:26,color:DK.txt,letterSpacing:"-.5px"}}>{profile.name}</div>
        {handle&&<div style={{fontFamily:"'JetBrains Mono',monospace",fontSize:13,color:AC,marginTop:3}}>@{handle}</div>}
        {profile.bio&&<p style={{color:DK.mu,fontSize:13,marginTop:8,lineHeight:1.5}}>{profile.bio}</p>}
      </div>

      {/* Score card */}
      <div style={{background:`linear-gradient(135deg,${t.color}20,${t.color}08)`,border:`1.5px solid ${t.color}45`,borderRadius:22,padding:"26px 18px",marginBottom:20,textAlign:"center",boxShadow:`0 0 48px ${t.glow},0 4px 24px ${t.color}20`,position:"relative",overflow:"hidden"}}>
        <div style={{position:"absolute",inset:0,background:`radial-gradient(ellipse at 50% 0%,${t.color}18,transparent 70%)`,pointerEvents:"none"}}/>
        <div style={{fontSize:11,fontFamily:"'JetBrains Mono',monospace",color:t.color,letterSpacing:".12em",textTransform:"uppercase",marginBottom:8,opacity:.8}}>Total Score</div>
        <div style={{fontFamily:"'JetBrains Mono',monospace",fontSize:72,fontWeight:900,color:t.color,lineHeight:1,textShadow:`0 0 32px ${t.color}60`,letterSpacing:"-3px"}}>{sc!=null?fmtScore(sc):"—"}</div>
        <div style={{fontSize:11,color:DK.mu,marginTop:4,marginBottom:12,fontFamily:"'JetBrains Mono',monospace"}}>points</div>
        <div style={{display:"flex",justifyContent:"center"}}><TierBadge sc={sc} isBiz={isBiz} size="md"/></div>
        <div style={{fontSize:12,color:DK.mu,marginTop:10}}>{n} {isBiz?"review":"rating"}{n!==1?"s":""}</div>
      </div>

      {/* Category bars */}
      {n>0&&<div style={{background:DK.card,border:`1px solid ${DK.b1}`,borderRadius:18,padding:"18px",marginBottom:20}}>
        <div style={{fontWeight:700,fontSize:13,color:DK.txt,marginBottom:16,letterSpacing:"-.2px"}}>{isBiz?"Review Breakdown":"Rating Breakdown"} <span style={{color:DK.mu,fontWeight:400}}>· {n} {isBiz?"reviews":"ratings"}</span></div>
        {cats.map(c=>{const v=cAvg(profile,c.id);return<div key={c.id} style={{marginBottom:13}}>
          <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:5}}>
            <span style={{fontSize:12,color:DK.mu,fontWeight:500}}>{c.emoji} {c.label}</span>
            <span style={{fontFamily:"'JetBrains Mono',monospace",fontSize:12,fontWeight:800,color:v>=80?"#4ade80":v>=60?profile.color:DK.mu}}>{v}/100</span>
          </div>
          <div style={{height:7,background:DK.faint,borderRadius:99,overflow:"hidden"}}>
            <div style={{width:`${v}%`,height:"100%",background:v>=80?`linear-gradient(90deg,#4ade8099,#4ade80)`:`linear-gradient(90deg,${profile.color}80,${profile.color})`,borderRadius:99,transition:"width .8s"}}/>
          </div>
        </div>;})}
      </div>}

      {/* CTA — Rate this profile */}
      <div style={{background:`linear-gradient(135deg,${AC}14,${AC}08)`,border:`1.5px solid ${AC}30`,borderRadius:18,padding:"22px 18px",textAlign:"center",marginBottom:16,boxShadow:`0 0 30px ${AC}10`}}>
        <div style={{fontWeight:800,fontSize:18,color:DK.txt,marginBottom:6}}>
          {isBiz?`Review ${profile.name}`:`Rate ${profile.name.split(" ")[0]}`}
        </div>
        <div style={{fontSize:13,color:DK.mu,marginBottom:18,lineHeight:1.6}}>
          {isBiz?"Create a free account to leave your review and see what others say about this business.":"Join HighEnough free — rate friends, build your own rep, and climb the tiers."}
        </div>
        <button onClick={onJoin} style={{width:"100%",padding:"14px 0",background:`linear-gradient(135deg,${AC}e0,${AC}90)`,borderRadius:13,color:"#fff",fontWeight:700,fontSize:16,marginBottom:10,boxShadow:`0 6px 20px ${AC}40`}}>
          Create Free Account 🚀
        </button>
        <div style={{fontSize:12,color:DK.mu}}>Already on HighEnough? <span onClick={onJoin} style={{color:AC,cursor:"pointer",fontWeight:700}}>Log in to rate →</span></div>
      </div>

      {/* Share row */}
      <div style={{display:"flex",gap:8}}>
        <button onClick={shareLink} style={{flex:1,padding:"11px 0",background:DK.faint,border:`1px solid ${DK.b1}`,borderRadius:10,color:DK.txt,fontWeight:600,fontSize:13}}>📤 Share</button>
        <button onClick={copyLink} style={{flex:1,padding:"11px 0",background:DK.faint,border:`1px solid ${DK.b1}`,borderRadius:10,color:DK.txt,fontWeight:600,fontSize:13}}>{cp?"Copied ✓":"🔗 Copy Link"}</button>
      </div>
    </div>

    {/* Footer */}
    <div style={{textAlign:"center",padding:"16px",borderTop:`1px solid ${DK.b1}`,fontSize:11,color:DK.mu}}>
      <span style={{fontWeight:700,color:DK.txt}}>High<span style={{color:AC,fontWeight:300}}>Enough</span></span> · Rate · Rise · Repeat · highenough.in
    </div>
  </div>;
}
...
/* ── CHAT SCREEN — implemented in js/components/messenger.js ── */
function ChatScreen(props){
  const Mod=window.HE_COMPONENTS&&window.HE_COMPONENTS.MessengerChatScreen;
  if(!Mod)return null;
  return React.createElement(Mod,props);
}
...
function InboxTab({convs,myProfile,T,onOpen,onDeleteConv,onViewProfile}){
  console.log("[HE_DEBUG][inboxtab-render] window.HE_COMPONENTS exists:",!!window.HE_COMPONENTS,"| window.HE_COMPONENTS.MessengerInbox exists:",!!(window.HE_COMPONENTS&&window.HE_COMPONENTS.MessengerInbox),"| convs.length received as prop:",convs?.length);
  const Mod=window.HE_COMPONENTS&&window.HE_COMPONENTS.MessengerInbox;
  if(!Mod){
    console.log("[HE_DEBUG][inboxtab-render] FALLBACK TRIGGERED — rendering hardcoded 'No messages yet' because MessengerInbox is not registered on window.HE_COMPONENTS. convs.length was:",convs?.length);
    return<div style={{padding:40,color:T.mu,textAlign:"center",fontSize:13}}>No messages yet</div>;
  }
...
function App(){
  ...
  // We only need the splash while onAuthStateChange confirms + loads profile.
  const [authLoading,setAuthLoading]=useState(!HE_BOOT_READY||!!HE_PREFETCHED_SESSION);
  const [dataReady,setDataReady]=useState(false); // true after loadAppData completes
  ...
  const [prefs,setPrefs]=useState(DP);
  ...
  const showAdminLockRef=useRef(false);
  const tabRef=useRef("feed");
  const qrTRef=useRef(null);
  const editProfileRef=useRef(false);
  const photoRef=useRef(false);
  const scoreCardRef=useRef(null);
  const showBlockedRef=useRef(false);
  const prevUnreadMRef=useRef(0); // [HE_DEBUG] tracks previous unread-badge value for before/after diagnostic logging
  ...
  useEffect(()=>{showAdminLockRef.current=showAdminLock;},[showAdminLock]);
  useEffect(()=>{tabRef.current=tab;},[tab]);
  useEffect(()=>{qrTRef.current=qrT;},[qrT]);
  useEffect(()=>{editProfileRef.current=editProfile;},[editProfile]);
  useEffect(()=>{photoRef.current=photo;},[photo]);
  useEffect(()=>{scoreCardRef.current=scoreCard;},[scoreCard]);
  useEffect(()=>{showBlockedRef.current=showBlocked;},[showBlocked]);

  // ── Android / browser back button handler — reads from refs, never stale ──
  useEffect(()=>{
  ...
  const T=prefs.dark?DK:LT;
  const pop=msg=>{setToast(msg);setTimeout(()=>setToast(null),2500);};

  // ── Load saved prefs ──
  useEffect(()=>{const p=getPref();if(p.dark!==undefined)setPrefs(prev=>({...prev,...p}));},[]);
  ...
  useEffect(()=>{
    ...
    // bootUser — single entry point for all auth paths.
    async function bootUser(user, dl){
      // Prevent concurrent boots for the same user
      ...
      if(isGoogle){
        ...
        if(delRow){
          ...
          // Explicitly delete any profile row matching this email regardless of id —
          // covers the case where delete-by-id above was silently blocked by RLS
          // (RLS checks auth.uid() === row.id; auth.uid() is now the new uid,
          // so deleting the row owned by oldId may fail silently).
          if(user.email){
            await sb.from("profiles").delete().eq("email",user.email);
          }
          // Brief flush: ensures the deletes above are visible to subsequent reads
          // before loadProfile immediately queries the profiles table.
      ...
      if(deleted){
        ...
        if(existingProfile){
          ...
          await Promise.all([
            ...
            sb.from("follows").delete().eq("follower_id",user.id),
            sb.from("follows").delete().eq("following_id",user.id),
            sb.from("messages").delete().eq("sender_id",user.id),
    ...
    function clearSession(){
      ...
      profileLoadingRef.current=false;
      bootingUserIdRef.current=null;
      // Clear the pre-fetched session so the spinner guard doesn't re-trigger
    ...
    // Safety net: if INITIAL_SESSION never fires (rare), unblock after 8s
    const splashTimer=setTimeout(()=>setAuthLoading(false), 8000);
    ...
    const {data:{subscription}}=sb.auth.onAuthStateChange(async(event,session)=>{
      ...
      if(event==="INITIAL_SESSION"){
        ...
        if(effectiveSession?.user){
          ...
          // HE_BOOT already called getSession() before mount — if it found nothing,
          // there is genuinely no session. No need to call getSession() again.
          // Genuinely no session — show login (or public deep-link profile)
          if(pendingDlRef.current){
            const dl=pendingDlRef.current;
            try{
              let q=sb.from("profiles").select("*");
              if(dl.type==="handle")q=q.ilike("handle",`%${dl.val}%`);
              else if(dl.type==="short_id"||dl.type==="invite")q=q.eq("short_id",dl.val);
              else q=q.eq("id",dl.val);
              const {data}=await q.limit(1).maybeSingle();
              if(data){
                const {data:rr}=await sb.from("ratings").select("*").eq("target_id",data.id);
                setDeepLinkProfile({...data,ratings:(rr||[]).map(r=>({raterId:r.rater_id,raterName:r.rater_name||"",vibe:r.vibe,humor:r.humor,kindness:r.kindness,rizz:r.rizz,loyalty:r.loyalty,drip:r.drip,ts:new Date(r.updated_at).getTime()}))});
              }
            }catch{}
          }
          setAuthLoading(false);
      ...
      // ── SIGNED_IN fires for: Google OAuth, email confirmation ────────
      // For email/password: handleAuthed() already called bootUser with this
      // user ID and set bootingUserIdRef. We skip here to prevent double-load.
      ...
      // ── Sign-out ──────────────────────────────────────────────────────
        ...
        const intentional=localStorage.getItem("he_intent_signout")==="true";
        localStorage.removeItem("he_intent_signout");

        if(!intentional){
          // Token refresh failure — try to recover once (no page reload ever)
          try{
  ...
  // ── Deep link handler — works both on fresh load AND when app comes to foreground ──
  // Root cause of QR scan not working: parseDeepLink() only ran once at mount.
  // If the PWA was already open and user scans a QR, the URL changes but mount never
  // re-fires. This visibilitychange listener re-checks the URL every time the app
  // becomes visible — so scanning a QR always opens the right profile.
  useEffect(()=>{
    async function handleDeepLinkUrl(){
      const dl=parseDeepLink();
      if(!dl)return;
      // Don't act on deep link if there's no logged-in user with a loaded profile
      ...
      try{
        ...
        const {data:dlp}=await q.limit(1).maybeSingle();
        if(dlp){
          // Merge ratings from already-loaded profiles state if available
          const existing=profilesRef.current.find(p=>p.id===dlp.id);
          const full=existing||dlp;
          if(!existing){
      ...
      }catch(e){console.error("handleDeepLinkUrl error:",e);}
    }

    // Fire once on mount (handles fresh page load from QR scan)
    handleDeepLinkUrl();

    // Fire every time the app comes back to foreground (handles PWA already open in background)
    function onVisible(){if(document.visibilityState==="visible")handleDeepLinkUrl();}
  ...
  async function loadProfile(userId,dl=null,authUser=null){
    try{
      ...
      if(error){
        ...
        const res2=await sb.from("profiles").select("*").eq("id",userId).maybeSingle();
        if(res2.error){
          console.error("loadProfile retry failed:",res2.error);
          setAuthError("Could not load your profile. Please log in again.");
          await sb.auth.signOut();
          profileLoadingRef.current=false;
          bootingUserIdRef.current=null;
          return;
      ...
      if(data){
        ...
        try{
          ...
          if(cu?.email){
            ...
            if(ep&&ep.id!==userId){
              // Before blocking: check whether the conflicting profile belongs to
              // a previously deleted account. If so, it is a stale recovery row
              // (RLS or replication lag prevented its deletion in bootUser).
              // Delete it and allow onboarding to proceed instead of blocking.
              const {data:staleDel}=await sb.from("deleted_accounts").select("auth_id").eq("auth_id",ep.id).maybeSingle();
              if(staleDel){
                console.log("[HE_DEBUG] onboarding decision — stale profile from deleted account detected, cleaning up and proceeding");
                await sb.from("profiles").delete().eq("id",ep.id);
                // fall through to ProfileSetup below
              } else {
  ...
  async function loadBackgroundData(uid,myProfile,deletedRaw,dl){
    ...
    try{
      ...
      if(md){
        ...
        const initialUnreadBreakdown=convList.map(cv=>({cid:cv.id,unread:cv.messages.filter(m=>m.sid!==uid&&m.read!==true).length})).filter(x=>x.unread>0);
        console.log("[HE_DEBUG][initial-load] messages fetched:",md.length,"(cap: 300)","| conversations built:",convList.length,
          "| conversations with unread at load:",initialUnreadBreakdown.length,
          "| breakdown:",initialUnreadBreakdown.map(x=>`${x.cid}(${x.unread})`).join(", ")||"none");
        setConvs(convList);
      }
    ...
    try{
      sb.channel(`rt_user_${uid}`)
        .on("postgres_changes",{event:"INSERT",schema:"public",table:"messages"},payload=>{
          ...
          const contributesToUnread=newMsg.sid!==uid&&newMsg.read!==true;
          console.log("[HE_DEBUG][realtime-insert] message received — cid:",cid,"| sender:",m.sender_id,"| contributes to unread:",contributesToUnread,"| this device is receiver:",m.receiver_id===uid);
          setConvs(prev=>{
        ...
        .on("postgres_changes",{event:"UPDATE",schema:"public",table:"messages"},payload=>{
          ...
          console.log("[HE_DEBUG][realtime-update] message status/read changed — cid:",cid,"| dbId:",m.id,"| incoming read:",m.read,"| incoming status:",m.status);
  ...
  async function handleMarkRead(cid,otherId){
    ...
    const beforeConv=convs.find(c=>c.id===cid);
    const beforeUnread=(beforeConv?.messages||[]).filter(m=>m&&m.sid&&m.sid!==profile.id&&m.read!==true&&!String(m.dbId||"").startsWith("temp_")).length;
    console.log("[HE_DEBUG][mark-read] called — cid:",cid,"| resolvedOtherId:",resolvedOtherId,"| unread BEFORE:",beforeUnread);
    ...
    console.log("[HE_DEBUG][mark-read] optimistic local update applied — cid:",cid,"| unread AFTER (local):",0);
    if(!resolvedOtherId)return;
    const {error:markReadErr}=await sb.from("messages")
      .update({read:true,status:"seen"})
      .eq("sender_id",resolvedOtherId)
      .eq("receiver_id",profile.id)
      .eq("read",false);
    console.log("[HE_DEBUG][mark-read] DB write resolved — cid:",cid,"| error:",markReadErr?.message||null);
  }
  ...
  // [HE_DEBUG] Inbox unread badge — permanent diagnostic trace. Fires on every
  // render this branch executes (i.e. whenever the tab bar is shown).
  {
    const convBreakdown=convs.map(cv=>{
      const msgs=cv.messages||[];
      const u=msgs.filter(m=>m&&m.sid&&m.sid!==profile.id&&m.read!==true&&!String(m.dbId||"").startsWith("temp_")).length;
      return{cid:cv.id,unread:u};
    }).filter(x=>x.unread>0);
    console.log("[HE_DEBUG][unread-badge] recalculated — total unread:",unreadM,
      "| conversations with unread:",convBreakdown.length,
      "| contributing conv ids:",convBreakdown.map(x=>`${x.cid}(${x.unread})`).join(", ")||"none",
      "| total convs in state:",convs.length);
    if(prevUnreadMRef.current!==unreadM){
      console.log("[HE_DEBUG][unread-badge] VALUE CHANGED —",prevUnreadMRef.current,"→",unreadM);
      prevUnreadMRef.current=unreadM;
    }
  }
  ...
  return<>
    <div style={{minHeight:"100vh",background:T.bg,color:T.txt,paddingBottom:"calc(68px + env(safe-area-inset-bottom))"}}>
      {/* HEADER */}
      ...
      {tab==="inbox"&&(()=>{
        console.log("[HE_DEBUG][inbox-transform] before transform — convs.length:",convs.length,"| profiles.length:",profiles.length);
        const mapped=convs.map(c=>{const other=profiles.find(p=>p.id===c.oid);return other?{...c,other}:null;});
        const nullCount=mapped.filter(x=>x===null).length;
        console.log("[HE_DEBUG][inbox-transform] after .map() — mapped.length:",mapped.length,"| null entries produced:",nullCount);
        const filtered=mapped.filter(Boolean);
        console.log("[HE_DEBUG][inbox-transform] after .filter(Boolean) — filtered.length:",filtered.length);
        if(filtered.length===0&&convs.length>0){
          const failedLookups=convs.map(c=>({cid:c.id,oid:c.oid,found:!!profiles.find(p=>p.id===c.oid)})).filter(x=>!x.found);
          console.log("[HE_DEBUG][inbox-transform] ALL CONVERSATIONS DROPPED — profile lookup failures:",failedLookups.map(x=>`cid=${x.cid} oid=${x.oid}`).join(" | ")||"none (unexpected)");
        }
        return<InboxTab convs={filtered} profiles={profiles} myProfile={profile} following={following} T={T} onOpen={(conv,other)=>setActiveChat({...conv,other})} onDeleteConv={handleDeleteConv} onViewProfile={p=>pushRoute('profile',p)}/>;
      })()}
